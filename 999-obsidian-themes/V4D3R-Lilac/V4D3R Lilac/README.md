...
> Dark theme with soft Lilac, Black, and Grey palette

## About

A color variant of the **V4D3R Crimson** Obsidian theme, auto-generated using
HSL hue rotation to transform all red-family accent colors to **Lilac**.
...
### Theme
1. Copy the `V4D3R Lilac` folder (containing `theme.css`, `manifest.json`,
   and this `README.md`) into your vault's `.obsidian/themes/` directory.
2. In Obsidian: Settings → Appearance → Themes → Select **V4D3R Lilac**.
