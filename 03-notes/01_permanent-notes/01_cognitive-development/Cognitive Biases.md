...
aliases:
  ...
  - cognitive bias
  - cognitive biases
  - Cognitive Biases_🆔20251105201124
link-up:
...
# 1. 🧠 FOUNDATIONAL CONCEPTS: THE "WHAT, HOW, AND WHY"
...
# 2. 📜 INTELLECTUAL HISTORY: THE HEURISTICS & BIASES PROGRAM
...
# 3. 🗺️ A COMPREHENSIVE CATEGORIZATION: THE COGNITIVE BIAS CODEX
...
# 4\. 🔑 KEY EXAMPLES: A RAPID REFERENCE CATALOG
...
# 5. 📈 KEY THEORETICAL MODEL: PROSPECT THEORY
...
# 7. 🛡️ MITIGATION STRATEGIES (DEBIASING)
...
>
> Consider the **Müller-Lyer illusion** (two lines of equal length, but one *looks* longer due to inward vs. outward-facing arrows).
>
