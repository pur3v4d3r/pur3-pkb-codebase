...
> [!definition]
> - **Key-Term**:: [[Getting Things Done (GTD)]]
> - [**Definition**:: A personal productivity system developed by David Allen that moves all items of interest, information, issues, tasks, and projects out of one's mind by recording them externally, then breaking them into actionable work items with known time limits.]
