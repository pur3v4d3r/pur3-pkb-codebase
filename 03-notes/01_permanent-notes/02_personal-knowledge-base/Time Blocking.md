...
> [!definition]
> - **Key-Term**:: [[03-notes/01_permanent-notes/02_personal-knowledge-base/Time Blocking]]
> - **Definition**:: A time management method where specific time blocks with defined start and end times are allocated to individual tasks or categories of work, creating a proactive schedule that protects focused work periods.
...
> 
> **Daily Refinement**
> 6. Morning review of time blocks
> 7. Adjustment based on energy levels and emerging priorities
> 8. Notification reminders as blocks approach
> 9. End-of-day review and next-day blocking
> 
