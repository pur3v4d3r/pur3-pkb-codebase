...
# CORE IDENTITY
# ═══════════════════════════════════════════════════════════════════════════
title: "Stage Characteristics and Training Implications"
aliases:
...
> [!definition] **Stage Characteristics and Training Implications** *(from [[cog-psy-attentional-efficiency-and-skill-aquisition]])*
...
> [!evidence] Supporting Evidence *(from [[cog-psy-attentional-efficiency-and-skill-aquisition]])*
> Logan and Klapp (1991) demonstrated that automaticity is highly specific to practiced instances. In alphabet arithmetic tasks (e.g., A+3=D), participants showed power law improvement with practice. However, when tested on novel problems using the same algorithm, performance reverted to slow, algorithmic processing - directly supporting the instance-specific prediction over rule-compilation accounts. Transfer occurred only when new problems were similar enough to activate previously stored…
...
> [!analytical-insight] Key Insight *(from [[cog-psy-attentional-efficiency-and-skill-aquisition]])*
...
> [!example] **Knowledge Compilation in Geometry** *(from [[cog-psy-attentional-efficiency-and-skill-aquisition]])*
...
> [!example] **Attentional Demand in Reading Development** *(from [[cog-psy-attentional-efficiency-and-skill-aquisition]])*
...
> [!example] **Routine vs Adaptive Expertise in Mathematics** *(from [[cog-psy-attentional-efficiency-and-skill-aquisition]])*
...
> [!example] **Expert-Induced Blindness** *(from [[cog-psy-attentional-efficiency-and-skill-aquisition]])*
...
[[expert-performance|expert-performance]] * [[memory-representation|memory-representation]] * [[production-system-theories|production system theories]] * [[ACT-R|ACT-R]] * [[consistent-mapping|consistent mapping]] * [[Event-related-potential|Event-related potential]] * [[functional-neuroimaging|functional neuroimaging]] * [[production-system|production system]] * [[Declarative-Knowledge|declarative knowledge]] * [[procedural-knowledge|Procedural-Knowledge]] * [[electrophysiology|electrophysiology]] * [[lesion-studies|lesion studies]] * [[prefrontal-cortex|prefrontal-cortex]] * [[goal-representations|goal representations]] * [[anterior-cingulate-cortex|anterior cingulate cortex]] * [[Effective-connectivity|Effective connectivity]] * [[basal-ganglia|Basal-Ganglia]] * [[Dopamine|Dopamine]] * [[sleep|sleep]] * [[REM-sleep|REM sleep]] * [[attentional-resource|attentional resource]] * [[Fitts-and-Posner|Fitts and Posner]] * [[ericsson|Ericsson]] * [[Chase-and-Simon|Chase and Simon]] * [[Chunking-Mechanisms-in-Skill-Acquisition|Chunking Mechanisms in Skill Acquisition]] * [[Neural-Plasticity-Mechanisms-in-Skill-Learning|Neural Plasticity Mechanisms in Skill Learning]] * [[Attention-Control-and-Executive-Function-in-Complex-Skills|Attention Control and Executive Function in Complex Skills]] * [[Transfer-of-Training:-Near-and-Far-Transfer-Phenomena|Transfer of Training: Near and Far Transfer Phenomena]] * [[Implicit-Learning-and-Unconscious-Skill-Acquisition|Implicit Learning and Unconscious Skill Acquisition]] * [[Expertise-in-Complex-Real-World-Domains|Expertise in Complex Real-World Domains]]


## Methodology Notes

> [!methodology-and-sources] **Measuring the Power Law** *(from [[cog-psy-attentional-efficiency-and-skill-aquisition]])*
...
> [!methodology-and-sources] **Measuring Neural Efficiency** *(from [[cog-psy-attentional-efficiency-and-skill-aquisition]])*
> Researchers use several converging measures of neural efficiency: (1) **Spatial extent**: counting activated voxels above threshold; (2) **Signal magnitude**: peak or mean activation strength; (3) **Energy consumption**: using PET to measure glucose metabolism; (4) **Temporal precision**: using EEG/MEG to measure response latency and variability. All typically decrease with practice in task-relevant regions, indicating increased efficiency. The most sophisticated analyses use multivariate pattern classification to show that while mean activation decreases, information content…

> [!methodology-and-sources] **Visual Search Paradigm** *(from [[cog-psy-attentional-efficiency-and-skill-aquisition]])*
...
> [!methodology-and-sources] **Feedback Timing Research** *(from [[cog-psy-attentional-efficiency-and-skill-aquisition]])*
...
> [!methodology-and-sources] **Variable Practice Implementation** *(from [[cog-psy-attentional-efficiency-and-skill-aquisition]])*
