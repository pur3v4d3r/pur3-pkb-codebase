---
title: "PKM/PKB Framework — Report Series Navigation"
aliases:
  - "Series Navigation MOC"
  - "30-Report Registry"
type: moc
status: evergreen
confidence: high
doc_id: "pkm-pkb-framework-series-moc-v1-0"
...
# PKM/PKB Framework — Report Series Navigation

> [!abstract] Purpose
> Complete registry of all 30 reports with summaries, original contributions, dependency mappings, and three recommended reading pathways. This MOC is the primary navigation tool for the report series itself.

---

## Series Architecture: The Four-Tier Knowledge Pyramid

The 30 reports form a **directed acyclic graph (DAG)** organized in four tiers. Each tier builds on the preceding tier's conceptual foundations.

| Tier | Reports | Purpose | Core Question |
|------|---------|---------|---------------|
| **1: Foundations** | 01–08 | Cognitive & architectural foundations | *How does the mind learn?* |
| **2: Integration** | 09–18 | Advanced PKB design guidance | *How should a PKB be designed?* |
| **3: Synthesis** | 19–26 | Sophisticated integration challenges | *How does the system mature?* |
| **4: Meta-Framework** | 27–30 | Framework-level integration | *What does it all mean?* |

---

## Recommended Reading Pathways

### Pathway A: Cognitive Foundations First (Recommended for scientists/researchers)

> Reports 01 → 02 → 06 → 09 → 15 → 17 → 20 → 25 → 27

Follows the cognitive science thread from knowledge architecture through memory mechanisms to PKB design to integration to unified framework.

### Pathway B: Design Translation (Recommended for PKB practitioners)

> Reports 09 → 01 → 02 → 15 → 17 → 12 → 20 → 27 → 30

Starts with the design destination (Report 09), then backtracks to understand the science, then builds toward implementation.

### Pathway C: Pedagogical Pathway (from the Synthesis document)
...
### [[10-scaffolding-and-fading-pkm-framework-2026-03-14|Report 10: Scaffolding and Fading — How PKB Structure Should Evolve with Expertise]]

**Original Contribution:** **[[Scaffolding-Fading Design]]** — PKB structure should evolve dynamically with user expertise
**Builds On:** Reports 02, 05 | **Feeds Into:** Reports 19, 24, 27

---

### [[11-transfer-problem-pkm-framework-2026-03-14|Report 11: The Transfer Problem — Making PKB Knowledge Usable Across Contexts]]

**Original Contribution:** **[[Contextual Bridging Architecture (CBA)]]** — Four-layer note design for knowledge transfer across contexts
**Builds On:** Reports 03, 07 | **Feeds Into:** Reports 17, 25
...
### [[18-calibration-epistemic-humility-pkm-framework-2026-03-15|Report 18: Calibration and Epistemic Humility — Knowing What You Know and Don't Know]]

**Original Contribution:** **[[Epistemic Accuracy Architecture]]** — Four-dimension framework (Correctness, Confidence Calibration, Application Competence, Explanation Clarity)
**Builds On:** Reports 04, 07, 12 | **Feeds Into:** Reports 26, 29
...
### [[20-retrieval-enhanced-knowledge-networks-pkm-framework-2026-03-15|Report 20: Retrieval-Enhanced Knowledge Networks — Designing PKB for Active Recall]]

**Original Contribution:** **[[RENS Framework]] + [[Cognitive Orphaning]]** — Retrieval-enhanced network strengthening; orphaned notes as primary failure mode

---

### [[21-dialectical-knowledge-building-pkm-framework-2026-03-15|Report 21: Dialectical Knowledge Building — Synthesis Through Productive Disagreement]]

**Original Contribution:** **[[Dialectical Note Triad (DNT)]]** — Three-node Obsidian structure (thesis, antithesis, synthesis) for epistemic accountability
...
### [[23-learning-environments-design-pkm-framework-2026-03-15|Report 23: Learning Environments Design — The PKB as a Constructed Learning Space]]

**Original Contribution:** **[[Personal Constructed Learning Environment (PCLE)]]** — Seven-component design vocabulary for PKB as learning environment

---

### [[24-self-determined-learning-pkm-framework-2026-03-15|Report 24: Self-Determined Learning and the PKB — From Pedagogy to Heutagogy]]

**Original Contribution:** **[[Knowledge Ecology Model]] + [[Epistemological Architecture Principle]]** — Heutagogical PKB architecture framing PAH as epistemological shift
...
### [[29-ethical-pkm-pkm-framework-2026-03-15|Report 29: Ethical PKM — Intellectual Honesty, Epistemic Responsibility, and Virtue in Knowledge Work]]

**Original Contribution:** **[[PKB as Ethical Mirror]] + [[Four Epistemic Duties of the PKB Curator]]** — Virtue epistemology applied to PKB curation

---

### [[30-future-pkm-ai-enhanced-knowledge-building-pkm-framework-2026-03-15|Report 30: The Future of PKM — AI-Enhanced Knowledge Building, Emerging Research, and Open Questions]]

**Original Contribution:** **[[Cognitive Partnership Model]] + [[Offloading Quality Distinction]] + [[Schema Construction Problem]]** — AI as Socratic interlocutor; challenge-oriented over convenience-oriented AI design
**Status:** Series capstone — synthesizes the full arc and introduces the central AI-era tension

---

## Key Dependency Threads

**Thread 1: Architecture** (How should a PKB be structured?)
```
Report 01 (Schema Theory) → Report 09 (PKB Design) → Report 15 (Organization at Scale) → Report 25 (Integration Problem) → Report 27 (Unified Framework)
```

**Thread 2: Construction** (How should knowledge be built?)
```
Report 03 (Constructivism) → Report 17 (Note-Making) → Report 16 (Desirable Difficulties) → Report 21 (Dialectics) → Report 27 (Constructive Processing Engine)
```
...
**Thread 4: Motivation** (How does PKM stay sustainable?)
```
Report 05 (SDT/AGT) → Report 13 (Emotional Regulation) → Report 19 (Lifelong Sustainability) → Report 24 (Heutagogy) → Report 27 (Motivational Alignment)
```

**Thread 5: AI Integration** (How should AI interact with learning?)
```
Report 16 (Desirable Difficulties) → Report 18 (Fluency Illusion) → Report 20 (Retrieval Architecture) → Report 30 (Cognitive Partnership Model)
```
...
> - **Parent:** [[00-PKM-PKB-Framework-Master-MOC]]
> - **Siblings:** [[00-PKM-PKB-Framework-Theoretical-Foundations-MOC]] · [[00-PKM-PKB-Framework-Original-Contributions-MOC]] · [[00-PKM-PKB-Framework-Design-Principles-MOC]] · [[00-PKM-PKB-Framework-Meta-Analysis-MOC]]
