...
Claude Code and Gemini Code Resouces Copedium
...
- [Awesome AI Coding Tools](#awesome-ai-coding-tools)
  ...
  - [🗄️ MCP Server/Tools](#️-mcp-servertools)
  - [📚 Related Lists](#-related-lists)
- [Awesome Claude ](#awesome-claude-)
  - [📋 Contents](#-contents)
  - [🏢 Official Anthropic Resources](#-official-anthropic-resources)
    - [🧠 Current Models (Claude 4.5 Family - Released 2025)](#-current-models-claude-45-family---released-2025)
    - [🔌 API \& Developer Platform](#-api--developer-platform)
    - [🔧 SDKs \& Development Tools](#-sdks--development-tools)
    - [☁️ Cloud Providers](#️-cloud-providers)
    - [🛡️ Transparency \& Safety](#️-transparency--safety)
