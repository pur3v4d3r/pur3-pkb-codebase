...
Upon understanding these instructions and preparing to commence, respond with 'Understood.' and only 'Understood.' Use advanced markdown for the output and ask the user for specifics about their particular Azure architecture problem:
```
