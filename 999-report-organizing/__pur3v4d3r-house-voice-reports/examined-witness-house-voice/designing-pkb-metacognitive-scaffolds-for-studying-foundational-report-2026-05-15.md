...
- [[#Abstract|Abstract]]
- [[#1. The Bootstrapping Problem: Why Studying Without Scaffolds Tends to Fail|1. The Bootstrapping Problem: Why Studying Without Scaffolds Tends to Fail]]
- [[#2. What a Metacognitive Scaffold Actually Is|2. What a Metacognitive Scaffold Actually Is]]
- [[#3. Layer One — Vocabulary Scaffolds: Naming What One Is Doing|3. Layer One — Vocabulary Scaffolds: Naming What One Is Doing]]
- [[#4. Layer Two — Procedural Scaffolds: Templated Movements Through Study|4. Layer Two — Procedural Scaffolds: Templated Movements Through Study]]
- [[#5. Layer Three — Architectural Scaffolds: The PKB as External Working Memory|5. Layer Three — Architectural Scaffolds: The PKB as External Working Memory]]
- [[#6. Layer Four — Reflective Scaffolds: Closing the Monitoring-Control Loop|6. Layer Four — Reflective Scaffolds: Closing the Monitoring-Control Loop]]
- [[#7. Layer Five — Fading: Designing Scaffolds That Render Themselves Unnecessary|7. Layer Five — Fading: Designing Scaffolds That Render Themselves Unnecessary]]
- [[#Far Transfer: Applying These Insights Beyond the PKB|Far Transfer: Applying These Insights Beyond the PKB]]
- [[#Synthesis and Integration|Synthesis and Integration]]
- [[#Appendix|Appendix]]
  - [[#A.1 Lexicon of Key Terms|A.1 Lexicon of Key Terms]]
  - [[#A.2 Key Figures & Intellectual Lineage|A.2 Key Figures & Intellectual Lineage]]
  - [[#A.3 Conceptual Tensions & Open Questions|A.3 Conceptual Tensions & Open Questions]]
  - [[#A.4 References|A.4 References]]
  - [[#A.5 Methodology & Sources Note|A.5 Methodology & Sources Note]]
  - [[#A.6 Argument Map: The Five-Layer Scaffold Stack|A.6 Argument Map: The Five-Layer Scaffold Stack]]
  - [[#A.7 Practical Application Protocols|A.7 Practical Application Protocols]]
  - [[#A.8 Spaced Repetition Seeds|A.8 Spaced Repetition Seeds]]
  - [[#A.9 Expansion Topics for the PKB|A.9 Expansion Topics for the PKB]]
  - [[#A.10 Connections to the PKB & Other Reports|A.10 Connections to the PKB & Other Reports]]
  - [[#A.12 Report Quality Self-Assessment|A.12 Report Quality Self-Assessment]]
