---
title: Complete coverage of metacognition theory, frameworks, and techniques
id: 20251113-081956
type: ""
status: seedling
rating: ""
...
link-up:
  - "[[cognitive-self-development_moc]]"
link-related: []
---
...
```mermaid
graph TB
    A[Meta-Level] -->|Control| B[Object-Level]
    B -->|Monitoring| A
    A -->|Assesses & Regulates| A
    B -->|Performs Cognition| B
...
```mermaid
graph LR
    A[Planning] -->|Execute| B[Monitoring]
    B -->|Complete| C[Evaluation]
    C -->|Informs Next| A
    B -->|Detect Problem| D[Control/Debugging]
    D -->|Adjust| B
