...
The mechanism by which problem centrality shapes learning is [[Schema Construction|Schema Construction]] under conditions of productive uncertainty. When a learner engages with an ill-structured problem, they cannot retrieve a pre-formed schema and apply it — they must construct a new schema by drawing on, combining, and sometimes restructuring prior knowledge. This construction process is the mechanism by which learning actually occurs, from the perspective of [[schema-theory-and-knowledge-organization|Schema Theory]] as developed by [[frederic-bartlett]] and extended by [[richard-anderson]] and [[john-sweller]].
