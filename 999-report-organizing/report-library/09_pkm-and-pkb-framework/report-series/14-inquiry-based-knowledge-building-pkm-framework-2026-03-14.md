...
The empirical base for this synthesis draws from three distinct research traditions: the cognitive psychology of elaborative interrogation and self-explanation, educational psychology of inquiry-based and problem-based learning, and the instructional design research on [[Productive Failure|Productive Failure]] and [[Desirable Difficulties (Robert Bjork, 1994)|Desirable Difficulties]]. These traditions converge in important ways, diverge in others, and together define the empirically grounded design space within which PKB inquiry architecture must be constructed.
