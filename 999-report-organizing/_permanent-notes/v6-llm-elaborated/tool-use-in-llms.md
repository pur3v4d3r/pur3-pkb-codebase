...
> *Follow the flow from input to tool invocation and back.*
>
> ```mermaid
> flowchart LR
...
>   B --> C[Tool Invocation]
>   C --> D[Tool Response]
>   D --> E[Integration into Output]
> ```


> [!abstract] **Diagram 2 — Reflective vs Reactive Thinking**
> *Compare the two thinking styles in LLM operations.*
>
> ```mermaid
> graph TD
>   A[Input] --> B[Reactive]
...
>   C --> E[Plan and Reason]
>   E --> F[Invoke Tool if Needed]
> ```


> [!abstract] **Diagram 3 — Tool Use vs Pure Generation**
> *Compare the two approaches in LLM output generation.*
>
> ```mermaid
> graph TD
>   A[Pure Generation] --> B[Internal Knowledge]
>   C[Tool Use] --> D[External Tools]
>   B --> E[Output]
>   D --> F[Enhanced Output]
> ```
