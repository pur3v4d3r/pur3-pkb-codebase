...
> *Follow the flow from text input to output interpretation.*
>
> ```mermaid
> flowchart LR
>   A[Text Input] --> B[Parsing]
>   B --> C[Linguistic Patterns]
>   C --> D[Spatial Relations Inference]
>   D --> E[Output Interpretation]
> ```


> [!abstract] **Diagram 2 — Performance on Spatial Descriptions**
> *Compare performance across different description formats.*
>
> ```mermaid
> graph TD
>   A[Canonical Directions] -->|Reliable| B[LLM Performance]
>   C[Coordinate-Based] -->|Poor| B
>   D[Survey Descriptions] -->|Deteriorates| B
> ```


> [!abstract] **Diagram 3 — Text-Statistical vs Simulation-Based**
> *Compare text-statistical and simulation-based approaches.*
>
> ```mermaid
> classDiagram
>   class Text_Statistical{
>     +Linguistic_Patterns()
>     -Infer_Spatial_Relations()
>   }
>   class Simulation_Based{
>     +Internal_Geometric_Representation()
>     -Robust_Spatial_Reasoning()
>   }
> ```
