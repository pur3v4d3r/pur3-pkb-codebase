...
Intrinsic motivation is central to understanding human behavior within the framework of Self-Determination Theory (SDT). It involves engaging in activities for personal enjoyment or interest, without external rewards. This form of motivation is considered a prototypical example of autonomous motivation, which means it arises from internal volition and self-endorsed values.

The importance of intrinsic motivation extends beyond individual satisfaction; it plays a crucial role in various domains such as education and the workplace. For instance, students who are intrinsically motivated tend to perform better academically because they find learning enjoyable and personally fulfilling. Similarly, employees with high levels of intrinsic motivation often exhibit greater job satisfaction and productivity.

Theoretical roots of intrinsic motivation can be traced back to SDT's organismic metatheory, which posits that individuals have innate needs for competence, autonomy, and relatedness. These needs drive behavior, and when they are satisfied through activities, it fosters intrinsic motivation. Conversely, external pressures or rewards can undermine these needs, leading to a decrease in intrinsic motivation.
...
> In instructional design, fostering intrinsic motivation is crucial for effective learning outcomes. Teachers who create engaging and challenging tasks that allow students to experience competence and autonomy tend to produce better academic performance. For example, project-based learning can enhance intrinsic motivation by allowing students to explore topics of personal interest.
...
> Intrinsic motivation involves engaging in activities for personal enjoyment or interest, whereas extrinsic motivation is driven by external rewards such as money or praise. The key difference lies in the source of regulation; intrinsic motivation arises from internal volition and self-endorsed values, while extrinsic motivation is externally supplied.
...
- **Edward L. Deci** — Co-originator of Self-Determination Theory (SDT) in 1971, along with Richard M. Ryan, and a key figure in the development of intrinsic motivation theory.
- **Richard M. Ryan** — Co-originator of SDT in 1985, alongside Edward L. Deci, and a leading researcher on intrinsic motivation and its role in human behavior.

## Open Questions

> [!open-question] **Question**
> What are the long-term effects of undermining intrinsic motivation through external rewards?
>
> *What would resolve it:* Longitudinal studies tracking changes in intrinsic motivation over extended periods would help clarify these effects.

> [!open-question] **Question**
> Can intrinsic and extrinsic motivations coexist in a balanced way?
>
...
Intrinsic motivation also has broader implications across various domains such as health, creativity, and social relationships. It is a key factor in sustaining long-term engagement and resilience, making it an essential concept for psychologists, educators, and organizational leaders.
