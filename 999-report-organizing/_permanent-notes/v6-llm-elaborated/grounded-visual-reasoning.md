...
> [!abstract] **Diagram 1 — Grounded Visual Reasoning Process Flow**
> *Follow the steps from identifying regions to generating responses.*
>
> ```mermaid
> flowchart LR
>   A[Identify Regions] --> B[Focused Interpretation]
>   B --> C[Generate Responses]
> ```


> [!abstract] **Diagram 2 — Attention Mechanisms in Vision-Language Models**
> *See how attention is guided by prompts to specific image regions.*
>
> ```mermaid
> flowchart LR
>   A[Prompt] --> B[Selective Attention]
>   B --> C[Localized Description]
> ```


> [!abstract] **Diagram 3 — Grounded vs Holistic Reasoning Comparison**
> *Compare grounded reasoning with holistic image description.*
>
> ```mermaid
> graph TD
>   A[Grounded Visual Reasoning] -->|Focus on Specific Regions| B[Holistic Image Description]
>   B -->|No Spatial Grounding| C
> ```
