...
>   C --> D[Instructions]
>   D --> E[Evaluating Model]
>   E --> F[Score/Rank Responses]
> ```


> [!abstract] **Diagram 2 — Comparison of Evaluation Methods**
> *Compare the characteristics of automated and human evaluations.*
>
> ```mermaid
> graph TD
>   A[Automated Evaluation] -->|Consistency| B[Criteria Application]
>   A -->|Scalability| C[Throughput]
>   A -->|Bias| D[Inherent Model Biases]
>   E[Human Evaluation] -->|Subjectivity| F[Judgment Variance]
>   E -->|Nuanced Feedback| G[Careful Consideration]
> ```


> [!abstract] **Diagram 3 — Reflective vs Reactive Thinking in Evaluations**
> *Identify the differences between reflective and reactive thinking approaches.*
>
> ```mermaid
> graph TD
>   A[Human Evaluation] -->|Reflective| B[Nuanced Feedback]
>   C[Model-Graded Evaluation] -->|Reactive| D[Rapid Response]
> ```
