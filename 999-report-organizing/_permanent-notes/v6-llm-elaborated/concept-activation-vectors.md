...
> [!abstract] **Diagram 1 — Concept Activation Vectors Overview**
> *Follow the flow from concept selection to model sensitivity analysis.*
>
> ```mermaid
> flowchart LR
>   A[Select Concepts] --> B[Curate Examples]
>   B --> C[Train Classifier]
>   C --> D[Generate Vectors]
>   D --> E[Evaluate Sensitivity]
> ```


> [!abstract] **Diagram 2 — CAV Mechanism Flow**
> *Trace the steps from example sets to concept vectors.*
>
> ```mermaid
> flowchart LR
...
> [!abstract] **Diagram 3 — Practical Implications of CAVs**
> *Identify the applications and their corresponding impacts.*
>
> ```mermaid
> graph TD
>   A[Debugging Model Decisions] --> B[Auditing Model Decisions]
>   B --> C[Understanding Model Behavior]
> ```
