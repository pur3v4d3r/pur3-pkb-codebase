...
Feedback Design for Autonomy and Mastery focuses on providing learners with constructive, non-controlling feedback that enhances their sense of competence and autonomy. This approach ensures that feedback is specific to the work rather than the individual, offering clear progress information against task criteria instead of comparing them to peers. By framing suggestions as options, it respects learner choice and promotes self-regulation. Explicitly acknowledging the learner's perspective fosters a supportive environment where learners feel valued and motivated.

In practice, this feedback design operates by ensuring that evaluative comments are aligned with clear learning objectives and criteria for success. For instance, instead of saying 'You did well,' it might say, 'Based on your current work, you have met the criteria for level 3 in this task.' This not only provides concrete information but also empowers learners to make informed decisions about their next steps. The feedback is designed to be actionable and respectful, encouraging learners to take ownership of their learning journey.

Theoretical roots of Feedback Design for Autonomy and Mastery can be traced back to Self-Determination Theory (SDT) and achievement-goal theory. SDT posits that autonomy-supportive practices enhance intrinsic motivation by fostering a sense of competence and relatedness. Achievement-goal theory emphasizes the importance of mastery goals over performance goals, encouraging learners to focus on learning rather than outperforming others. By integrating these theories into instructional design, educators can create feedback systems that support both cognitive development and psychological well-being.
...
> In instructional design, Feedback Design for Autonomy and Mastery can be implemented by creating rubrics that clearly outline criteria for success. For example, a teacher might provide feedback on a student's essay by highlighting specific strengths and areas for improvement rather than giving a general grade. This approach not only provides clear guidance but also respects the learner’s autonomy in making decisions about their next steps.

> [!example] **Application 2 — Classroom management**
> In classroom settings, teachers can use this feedback design to foster a positive learning environment where students feel supported and motivated. By providing specific, constructive feedback on assignments, teachers can help students understand what they are doing well and how they can improve. This approach reduces the risk of demotivating students with negative or controlling feedback.
...
> How can educators ensure they do not fall into the pitfall of vacuous praise?
>
