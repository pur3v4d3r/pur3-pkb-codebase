...
> [!definition] **Starburst Galaxy**
> A Starburst Galaxy is characterized by an elevated star-formation rate that surpasses its long-term average by factors of ten or more, depleting the available gas reservoir on a timescale much shorter than the galaxy's age. This phenomenon excludes galaxies with normal star formation rates and highlights transient bursts rather than steady-state processes. It falls under Galaxy Classification in astrophysics.

> [!attention] **Boundary**
> This definition excludes galaxies with normal star formation rates and focuses on those experiencing transient, high-rate bursts. It should not be confused with other types of galaxies such as elliptical or spiral galaxies which do not exhibit this characteristic burst of star formation.

## Core Explanation

Starburst Galaxies are distinguished by their exceptionally high rate of star formation, which can be triggered by various mechanisms but is most commonly associated with gravitational interactions or mergers between galaxies. These events drive gas towards the central regions of a galaxy, where it accumulates and leads to an intense burst of star creation. The rapid consumption of this gas reservoir sets these galaxies apart from those experiencing normal rates of star formation.

Theoretical models suggest that the conditions necessary for a starburst are met when gravitational forces compress interstellar clouds to densities sufficient for them to collapse under their own gravity, initiating stellar nucleosynthesis at an accelerated pace. This process is not only rapid but also highly efficient in converting gas into stars, often leading to the formation of massive stars which can further influence the galaxy's evolution through supernova explosions and feedback mechanisms.
...
The intense burst of star formation in Starburst Galaxies often leads to the creation of ultraluminous infrared galaxies (ULIRGs), which are characterized by their extremely high luminosity in the far-infrared part of the spectrum. This radiation is primarily due to the reprocessing of optical and UV light from young, massive stars into longer wavelengths by dust clouds within these galaxies.

## Practical Implications

> [!example] **Application 1 — Galaxy Evolution**
> Understanding Starburst Galaxies is crucial for studying galaxy evolution because they represent a phase where galaxies undergo rapid transformation. During starbursts, the intense formation of massive stars can lead to significant feedback effects that alter the structure and dynamics of the host galaxy. Ignoring these bursts would result in an incomplete picture of how galaxies evolve over time.
...
> What triggers the initial conditions for a starburst in a galaxy?
>
> *What would resolve it:* Detailed simulations and observational studies that track gas dynamics and gravitational interactions could provide insights into the specific conditions necessary to initiate a starburst.

> [!open-question] **Question**
> How do starbursts affect the long-term evolution of galaxies?
>
...
Observations and theoretical models consistently highlight that gravitational interactions or mergers are primary drivers of starbursts in galaxies. These events funnel gas into dense regions where it can efficiently form stars, leading to the characteristic elevated star-formation rates observed in Starburst Galaxies.

## Connections & Context

**Falls under:** [[Galaxy Classification]]

**Specializes:** [[Irregular Galaxy]]
