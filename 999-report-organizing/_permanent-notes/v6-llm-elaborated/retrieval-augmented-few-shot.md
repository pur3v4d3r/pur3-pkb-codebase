...
> [!abstract] **Diagram 1 — RAFS Process Flow**
> *Follow the flow from input to retrieval and response generation.*
>
> ```mermaid
> flowchart LR
...
> [!abstract] **Diagram 2 — Dynamic vs Static Few-Shot Sets**
> *Compare the dynamic and static approaches to few-shot prompting.*
>
> ```mermaid
> graph TD
>   A[Input] --> B[Dynamic Selection]
>   A --> C[Static Set]
>   B --> D[Relevant Examples]
>   C --> E[Fixed Examples]
> ```


> [!abstract] **Diagram 3 — Recognition vs Recall in RAFS**
> *Understand the roles of recognition and recall in retrieval-augmented prompting.*
>
> ```mermaid
> sequenceDiagram
>   participant Input
...
>   Input->>Recognition: Identify Relevant Examples
>   Recognition->>Recall: Retrieve Examples
>   Recall->>Response: Generate Response
> ```
