...
> *Follow the flow from initial persona to drift and strategies.*
>
> ```mermaid
> graph TD
>   A[Initial Persona]
...
>   E[Summarization]
>   A -->|System Prompt| B
>   B -->|Reinforce Attributes| C
>   B -->|Compress History| D
>   B -->|Generate Summaries| E
> ```
...
>   A -->|Periodic Reinforcement| D
>   B -->|Unmanaged Context| C
> ```


> [!abstract] **Diagram 3 — Reflective vs Reactive Thinking**
> *Understand the difference in response planning approaches.*
>
> ```mermaid
> graph TD
>   A[Reflective]
...
>   F[Isolated Responses]
>   A -->|Consider Long-term Goals| C
>   A -->|Maintain Persona| E
>   B -->|React to Immediate Cues| D
>   B -->|Isolate Responses| F
> ```
