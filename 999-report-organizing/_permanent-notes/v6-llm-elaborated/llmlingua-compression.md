...
> ```mermaid
> flowchart LR
>   A[Input Prompt] --> B[Score Tokens]
>   B --> C[Identify Low Perplexity]
>   C --> D[Remove Tokens]
>   D --> E[Compressed Prompt]
> ```


> [!abstract] **Diagram 2 — Token Perplexity Scoring Mechanism**
> *See how perplexity scores determine token removal.*
>
> ```mermaid
> graph TD
>   A[Context]
...
> [!abstract] **Diagram 3 — Comparison with Naive Truncation**
> *Compare LLMLingua's targeted removal vs. naive truncation.*
>
> ```mermaid
> sequenceDiagram
>   participant InputPrompt as IP
>   participant AuxiliaryModel as AM
>   participant TargetModel as TM
>   participant NaiveTruncation as NT
>   participant LLMLinguaCompression as LC
>   IP->>AM: Score Tokens
>   AM-->>IP: Perplexity Scores
>   IP->>LC: Remove Low-Perplexity Tokens
>   IP->>NT: Truncate Prompt
>   LC-->>TM: Efficient Compressed Prompt
>   NT-->>TM: Inefficiently Truncated Prompt
> ```
