...
> [!abstract] **Diagram 1 — Negative Prompting Process Flow**
> *Follow the flow from input to output, noting key steps and outcomes.*
>
> ```mermaid
> flowchart LR
>   A[Input] --> B[Negation Interpretation]
>   B --> C[Mental Simulation]
>   C --> D[Cognitive Reliability Check]
>   D --> E[Output]
> ```


> [!abstract] **Diagram 2 — Negative vs Positive Framing Comparison**
> *Compare the paths for negative and positive framing to understand their impacts.*
>
> ```mermaid
> graph TD
>   A[Input] --> B[Negative]
>   A --> C[Positive]
>   B --> D[Mental Simulation]
>   C --> E[Straightforward Processing]
>   D --> F[Cognitive Reliability Issues]
>   E --> G[Precise Control]
> ```


> [!abstract] **Diagram 3 — Negative Prompting Cognitive Load**
> *Trace the increase in cognitive load with more prohibitions.*
>
> ```mermaid
> flowchart LR
>   A[Single Prohibition] --> B[Cognitive Load]
>   B --> C[Moderate Reliability]
>   D[Multiple Prohibitions] --> E[Highest Cognitive Load]
>   E --> F[Limited Reliability]
> ```
