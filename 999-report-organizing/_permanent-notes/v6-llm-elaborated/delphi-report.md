...
The Delphi Report emerged from a process where forty-six critical-thinking experts reached a consensus through the Delphi method, ensuring that their definition was robust and widely accepted. This report identified six core cognitive skills: interpretation, analysis, evaluation, inference, explanation, and self-regulation, alongside a list of dispositional habits. These components were designed to provide a comprehensive yet focused framework for understanding critical thinking.

In practice, the Delphi Report's definition has been instrumental in shaping educational curricula and assessment tools. For instance, it informed the development of the California Critical Thinking Skills Test (CCTST), which measures these cognitive skills and dispositional habits. The report also influenced the creation of critical-thinking curricular standards, ensuring that educators had a clear set of criteria to guide their teaching.

The Delphi Report's definition is rooted in the broader field of educational psychology, particularly within the subfield of critical thinking education. It builds on earlier theories and research by emphasizing both cognitive processes and personal dispositions necessary for effective critical thinking. This dual focus ensures that educators can address not just what students should know but also how they should think.
...
> In instructional design, the Delphi Report's definition guides educators in creating curricula that explicitly target both cognitive skills and dispositional habits. For example, a course might include activities that promote self-regulation alongside exercises that enhance analytical thinking.

> [!example] **Application 2 — Assessment development**
> The report has led to the creation of assessment tools like the California Critical Thinking Skills Test (CCTST), which measures critical thinking skills and dispositions. These assessments help educators evaluate students' progress in developing their critical thinking abilities.
...
> How universal is the dispositional list across different cultures?
>
> *What would resolve it:* Cross-cultural studies comparing the effectiveness of the dispositional habits in diverse cultural contexts would help determine their universality.

> [!open-question] **Question**
> Is self-regulation truly a distinct cognitive skill or part of other processes?
>
