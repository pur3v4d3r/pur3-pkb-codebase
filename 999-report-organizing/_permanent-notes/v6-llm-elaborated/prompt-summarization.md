...
> ```mermaid
> flowchart LR
>   A[Input Prompt] --> B[Summarization Model]
>   B --> C[Tailored Summary]
>   C --> D[Task Execution]
> ```


> [!abstract] **Diagram 2 — Task-aware vs Generic Summaries Comparison**
> *Compare the compression ratios and performance of both types.*
>
> ```mermaid
> graph TD
>   A[Task-aware Summary] -->|High Compression Ratio| B[Retains Task-relevant Info]
>   C[Generic Summary] -->|Balanced Coverage| D[May Include Irrelevant Details]
> ```


> [!abstract] **Diagram 3 — Multi-turn Interaction Context Flow**
> *Track the context flow and potential error accumulation over turns.*
>
> ```mermaid
> sequenceDiagram
...
>   U->>M: Turn 1 Prompt
>   M-->>U: Summary 1
>   U->>M: Turn 2 Prompt with Summary 1
>   M-->>U: Summary 2
>   U->>M: Turn 3 Prompt with Summary 2
> ```
