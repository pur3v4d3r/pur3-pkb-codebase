...
SDL is a process where learners actively engage in diagnosing their needs and setting goals, identifying resources, selecting strategies, and evaluating outcomes. This involves a high degree of personal autonomy and initiative, making it distinct from self-teaching or learning without any structure. The foundational mechanism behind SDL lies in the learner's capacity to manage their own learning effectively, which is supported by a curriculum that provides both structure and autonomy.

In practice, SDL operates within a structured curriculum but emphasizes the development of autonomous learning skills. For instance, through learning contracts, learners can set personal goals and choose resources relevant to their needs, fostering intrinsic motivation and self-regulation. This approach aligns with the insights from educational theorists like Malcolm Knowles and Philip Candy, who have operationalized SDL for adult education.

Theoretical roots of SDL trace back to John Dewey's experiential learning theory, which emphasizes active engagement in real-world experiences. Knowles further developed this into andragogy, focusing on adult learners' readiness to learn autonomously. The concept also draws from self-regulated learning (SRL), where learners manage their own cognition, motivation, and behavior within given tasks, but SDL extends this by addressing the broader question of who controls the learning agenda.
...
> In instructional design, incorporating elements of SDL can enhance student engagement and learning outcomes. For example, using learning contracts allows students to set their own goals and choose resources relevant to their interests, fostering intrinsic motivation and self-regulation.

> [!example] **Application 2 — Curriculum development**
> Curriculum developers should design courses that provide clear expectations and rationale while offering learners meaningful choices. This balance helps internalize self-regulatory skills over time, preparing students for lifelong learning.
...
> How can curriculum design support the internalization of self-regulatory skills over time?
>
> *What would resolve it:* Further research on longitudinal studies tracking learners' development of self-regulatory skills could provide insights into optimal strategies for curriculum design.

> [!open-question] **Question**
> What are the optimal levels and types of scaffolding for different stages of learner development?
>
