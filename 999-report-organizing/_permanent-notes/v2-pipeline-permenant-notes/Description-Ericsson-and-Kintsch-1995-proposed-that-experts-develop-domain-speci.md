...
# CORE IDENTITY
# ═══════════════════════════════════════════════════════════════════════════
title: "**Description:** Ericsson and Kintsch (1995) proposed that experts develop domain-specific retrieval"
aliases:
  - "**Description"
  - "**Description:** Ericsson and Kintsch (1995) proposed that experts develop domain-specific retrieval"
type: permanent-note
status: seedling
confidence: low
...
> [!definition] ****Description:** Ericsson and Kintsch (1995) proposed that experts develop domain-specific retrieval**
