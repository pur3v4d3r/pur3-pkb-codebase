---
title: "Microsoft. (2024). *Language Server Protocol Specification — Version 3.17*. Microsoft."
aliases: [LSP v3.17, Language Server Protocol 3.17]
type: permanent-note
status: evergreen
confidence: high
...
# Microsoft. (2024). *Language Server Protocol Specification — Version 3.17*. Microsoft.

> [!definition] Microsoft. (2024). *Language Server Protocol Specification — Version 3.17*. Microsoft.
...
```dataview
LIST FROM [[Microsoft. (2024). Language Server Protocol Specification — Version 3.17. Microsoft]]
