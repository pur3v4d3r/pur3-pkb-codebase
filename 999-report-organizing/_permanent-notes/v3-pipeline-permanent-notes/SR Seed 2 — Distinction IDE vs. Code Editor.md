---
title: "SR Seed 2 — Distinction: IDE vs. Code Editor"
aliases: [Integrated Development Environment vs. Text Editor]
type: permanent-note
status: evergreen
confidence: high
...
# SR Seed 2 — Distinction: IDE vs. Code Editor

> [!definition] SR Seed 2 — Distinction: IDE vs. Code Editor
...
```dataview
LIST FROM [[SR Seed 2 — Distinction IDE vs. Code Editor]]
