---
title: "What is germane cognitive load and why is its status contested?"
aliases: [GC load, cognitive-load-theory]
type: permanent-note
status: evergreen
confidence: high
...
# What is germane cognitive load and why is its status contested?

> [!definition] What is germane cognitive load and why is its status contested?
...
```dataview
LIST FROM [[What is germane cognitive load and why is its status contested]]
