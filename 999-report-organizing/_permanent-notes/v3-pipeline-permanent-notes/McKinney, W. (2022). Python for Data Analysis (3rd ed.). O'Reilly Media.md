---
title: "McKinney, W. (2022). *Python for Data Analysis* (3rd ed.). O'Reilly Media."
aliases: [Data analysis with Python, Python programming for data science]
type: permanent-note
status: evergreen
confidence: high
...
> [!definition] McKinney, W. (2022). *Python for Data Analysis* (3rd ed.). O'Reilly Media.
...
```dataview
LIST FROM [[McKinney, W. (2022). Python for Data Analysis (3rd ed.). O'Reilly Media]]
