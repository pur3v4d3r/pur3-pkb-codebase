---
title: "Epistemic Risk 1: Cargo-Cult Coding"
aliases: [epistemic-risk-in-software-development, cargo-cult-programming]
type: permanent-note
status: evergreen
confidence: medium
...
# Epistemic Risk 1: Cargo-Cult Coding

> [!definition] Epistemic Risk 1: Cargo-Cult Coding
...
```dataview
LIST FROM [[Epistemic Risk 1 Cargo-Cult Coding]]
