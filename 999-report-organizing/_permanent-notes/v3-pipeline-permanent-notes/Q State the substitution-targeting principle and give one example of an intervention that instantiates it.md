---
title: "Q: State the substitution-targeting principle and give one example of an intervention that instantiates it."
aliases: []
type: permanent-note
status: evergreen
confidence: high
...
# Q: State the substitution-targeting principle and give one example of an intervention that instantiates it.

> [!definition] Q: State the substitution-targeting principle and give one example of an intervention that instantiates it.
...
```dataview
LIST FROM [[Q State the substitution-targeting principle and give one example of an intervention that instantiates it]]
