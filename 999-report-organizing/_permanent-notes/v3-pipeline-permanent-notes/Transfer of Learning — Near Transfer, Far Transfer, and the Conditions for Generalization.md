---
title: "Transfer of Learning — Near Transfer, Far Transfer, and the Conditions for Generalization"
aliases: [near-transfer, far-transfer, transfer-of-learning]
type: permanent-note
status: evergreen
confidence: high
...
# Transfer of Learning — Near Transfer, Far Transfer, and the Conditions for Generalization

> [!definition] Transfer of Learning — Near Transfer, Far Transfer, and the Conditions for Generalization
> The process by which knowledge or skills learned in one context are applied to a different but related context.

## Core Explanation

> [!evidence] Transfer of Learning — Near Transfer, Far Transfer, and the Conditions for Generalization
...
```dataview
LIST FROM [[Transfer of Learning — Near Transfer, Far Transfer, and the Conditions for Generalization]]
