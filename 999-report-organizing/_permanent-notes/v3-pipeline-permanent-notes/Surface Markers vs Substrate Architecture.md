---
title: "Surface Markers vs Substrate Architecture"
aliases: []
type: permanent-note
status: evergreen
confidence: medium
...
# Surface Markers vs Substrate Architecture

> [!definition] Surface Markers vs Substrate Architecture
> *Definition pending — derived from 1 source report(s).*

## Open Threads

> [!tension-identified] Surface Markers vs Substrate Architecture
...
```dataview
LIST FROM [[Surface Markers vs Substrate Architecture]]
