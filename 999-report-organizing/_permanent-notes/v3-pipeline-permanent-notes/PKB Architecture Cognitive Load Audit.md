---
title: "PKB Architecture Cognitive Load Audit"
aliases: [PKB-Cog-Load-Audit, Cognitive-Load-Audit]
type: permanent-note
status: evergreen
confidence: high
...
# PKB Architecture Cognitive Load Audit

> [!definition] PKB Architecture Cognitive Load Audit
> *Definition pending — derived from 1 source report(s).*

## Core Explanation

> [!evidence] PKB Architecture Cognitive Load Audit
...
```dataview
LIST FROM [[PKB Architecture Cognitive Load Audit]]
