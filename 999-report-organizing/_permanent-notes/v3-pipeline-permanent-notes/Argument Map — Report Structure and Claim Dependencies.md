---
title: "Argument Map — Report Structure and Claim Dependencies"
aliases: [argument diagram, claim mapping]
type: permanent-note
status: evergreen
confidence: medium
domain: pedagogy
...
# Argument Map — Report Structure and Claim Dependencies

> [!definition] Argument Map — Report Structure and Claim Dependencies
...
```dataview
LIST FROM [[Argument Map — Report Structure and Claim Dependencies]]
