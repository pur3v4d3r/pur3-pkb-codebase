---
title: "Name the Ten Steps of the 4C/ID design methodology."
aliases: [ADDIE, four-component instruction design]
type: permanent-note
status: evergreen
confidence: high
...
# Name the Ten Steps of the 4C/ID design methodology.

> [!definition] Name the Ten Steps of the 4C/ID design methodology.
...
```dataview
LIST FROM [[Name the Ten Steps of the 4CID design methodology]]
