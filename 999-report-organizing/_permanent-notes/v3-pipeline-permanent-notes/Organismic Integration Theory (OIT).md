...
> The sub-theory within SDT that addresses the development and dynamics of [[extrinsic-motivation|extrinsic motivation]], specifying the four regulatory styles ([[External Regulation|external]], [[introjection|introjected]], [[identified|identified]], [[Integrated Regulation|integrated]]) through which behaviors not done for their own sake can come to be self-endorsed. OIT is the SDT sub-theory that operationalizes the [[internalization|internalization continuum]].
