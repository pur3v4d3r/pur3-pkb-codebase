---
title: "Sweigart, A. (2019). *Automate the Boring Stuff with Python* (2nd ed.). No Starch Press."
aliases: [ABSP, Automate-the-Boring-Stuff-with-Python]
type: permanent-note
status: evergreen
confidence: high
...
> [!definition] Sweigart, A. (2019). *Automate the Boring Stuff with Python* (2nd ed.). No Starch Press.
...
```dataview
LIST FROM [[Sweigart, A. (2019). Automate the Boring Stuff with Python (2nd ed.). No Starch Press]]
