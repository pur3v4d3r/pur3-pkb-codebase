---
title: "Q: What is the difference between the algorithmic mind and the reflective mind in Stanovich's tripartite model?"
aliases: [algorithmic-versus-reflective-difference, stanovich-tripartite-model-mind-difference]
type: permanent-note
status: evergreen
confidence: high
...
# Q: What is the difference between the algorithmic mind and the reflective mind in Stanovich's tripartite model?

> [!definition] Q: What is the difference between the algorithmic mind and the reflective mind in Stanovich's tripartite model?
...
```dataview
LIST FROM [[Q What is the difference between the algorithmic mind and the reflective mind in Stanovich's tripartite model]]
