---
title: "Q: How does Gigerenzer's adaptive-heuristics view differ from the heuristics-as-bias view, and how can the two be reconciled?"
aliases: [gigerenzer-adaptive-heuristics-vs-heuristics-as-bias, adaptive-heuristics-vs-biased-heuristics]
type: permanent-note
status: evergreen
confidence: high
...
# Q: How does Gigerenzer's adaptive-heuristics view differ from the heuristics-as-bias view, and how can the two be reconciled?

> [!definition] Q: How does Gigerenzer's adaptive-heuristics view differ from the heuristics-as-bias view, and how can the two be reconciled?
...
```dataview
LIST FROM [[Q How does Gigerenzer's adaptive-heuristics view differ from the heuristics-as-bias view, and how can the two be]]
