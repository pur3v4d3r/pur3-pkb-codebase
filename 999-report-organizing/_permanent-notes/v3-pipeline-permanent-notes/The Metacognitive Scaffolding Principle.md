---
title: "The Metacognitive Scaffolding Principle"
aliases: [metacognitive scaffolding, scaffolding principle]
type: permanent-note
status: evergreen
confidence: high
...
> [!definition] The Metacognitive Scaffolding Principle
> *Definition pending — derived from 1 source report(s).*

## Core Explanation

> [!evidence] The Metacognitive Scaffolding Principle
...
```dataview
LIST FROM [[The Metacognitive Scaffolding Principle]]
