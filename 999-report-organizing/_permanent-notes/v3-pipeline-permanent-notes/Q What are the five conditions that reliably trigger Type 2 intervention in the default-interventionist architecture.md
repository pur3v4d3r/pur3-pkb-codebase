---
title: "Q: What are the five conditions that reliably trigger Type 2 intervention in the default-interventionist architecture?"
aliases: []
type: permanent-note
status: evergreen
confidence: high
...
# Q: What are the five conditions that reliably trigger Type 2 intervention in the default-interventionist architecture?

> [!definition] Q: What are the five conditions that reliably trigger Type 2 intervention in the default-interventionist architecture?
...
```dataview
LIST FROM [[Q What are the five conditions that reliably trigger Type 2 intervention in the default-interventionist architecture]]
