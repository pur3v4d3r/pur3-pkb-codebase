---
title: "SDT's Causal Architecture — Core Mediational Model"
aliases: [Self-Determination Theory's Core Mediational Model, Core Mediational Model of Self-Determination Theory]
type: permanent-note
status: evergreen
confidence: high
...
# SDT's Causal Architecture — Core Mediational Model

> [!definition] SDT's Causal Architecture — Core Mediational Model
...
```dataview
LIST FROM [[SDT's Causal Architecture — Core Mediational Model]]
