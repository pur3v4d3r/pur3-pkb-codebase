---
title: "Q: Define attribute substitution and explain why it produces systematic rather than random error."
aliases: [substitution-heuristic, hindsight-bias]
type: permanent-note
status: evergreen
confidence: high
...
# Q: Define attribute substitution and explain why it produces systematic rather than random error.

> [!definition] Q: Define attribute substitution and explain why it produces systematic rather than random error.
...
```dataview
LIST FROM [[Q Define attribute substitution and explain why it produces systematic rather than random error]]
