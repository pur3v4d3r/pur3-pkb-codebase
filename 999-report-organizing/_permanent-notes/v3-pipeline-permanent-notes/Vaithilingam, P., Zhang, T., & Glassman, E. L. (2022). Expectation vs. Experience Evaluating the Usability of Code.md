---
title: "Vaithilingam, P., Zhang, T., & Glassman, E. L. (2022). Expectation vs. Experience: Evaluating the Usability of Code Generation Tools Powered by Large Language Models. *CHI Conference on Human Factors in Computing Systems Extended Abstracts*."
aliases: [Evaluation of Usability in AI-Driven Code Generation, User Expectations vs. Reality in LLM-Powered IDEs]
type: permanent-note
status: evergreen
confidence: high
...
> [!definition] Vaithilingam, P., Zhang, T., & Glassman, E. L. (2022). Expectation vs. Experience: Evaluating the Usability of Code Generation Tools Powered by Large Language Models. *CHI Conference on Human Factors in Computing Systems Extended Abstracts*.
...
```dataview
LIST FROM [[Vaithilingam, P., Zhang, T., & Glassman, E. L. (2022). Expectation vs. Experience Evaluating the Usability of Code]]
