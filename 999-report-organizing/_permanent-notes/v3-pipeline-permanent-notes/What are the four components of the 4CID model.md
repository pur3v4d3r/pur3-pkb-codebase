---
title: "What are the four components of the 4C/ID model?"
aliases: [four-component instructional design model, 4c/id model]
type: permanent-note
status: evergreen
confidence: high
...
# What are the four components of the 4C/ID model?

> [!definition] What are the four components of the 4C/ID model?
...
```dataview
LIST FROM [[What are the four components of the 4CID model]]
