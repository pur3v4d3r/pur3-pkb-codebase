...
# 4. Schema (in CLT context)

> [!definition] 4. Schema (in CLT context)
> *Definition pending — derived from 2 source report(s).*

## Core Explanation

> [!evidence] 4. Schema (in CLT context)
...
```dataview
LIST FROM [[4. Schema (in CLT context)]]
