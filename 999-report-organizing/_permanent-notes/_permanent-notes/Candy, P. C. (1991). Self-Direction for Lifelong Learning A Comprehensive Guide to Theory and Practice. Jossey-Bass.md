---
title: "Candy, P. C. (1991). *Self-Direction for Lifelong Learning: A Comprehensive Guide to Theory and Practice*. Jossey-Bass."
aliases: []
type: permanent-note
status: evergreen
confidence: high
...
> [!definition] Candy, P. C. (1991). *Self-Direction for Lifelong Learning: A Comprehensive Guide to Theory and Practice*. Jossey-Bass.
...
```dataview
LIST FROM [[Candy, P. C. (1991). Self-Direction for Lifelong Learning A Comprehensive Guide to Theory and Practice. Jossey-Bass]]
