---
title: "Explicit-Reasoning-Externalization"
aliases: []
type: permanent-note
status: evergreen
confidence: high
...
# Explicit-Reasoning-Externalization
...
> [!evidence] Explicit-Reasoning-Externalization
> A systematic approach where the model generates visible, structured reasoning processes in designated `[Final user-facing response appears here after thinking is complete
...
```dataview
LIST FROM [[Explicit-Reasoning-Externalization]]
