---
title: "GitHub. (2024). *GitHub Copilot Documentation*. GitHub Docs."
aliases: []
type: permanent-note
status: evergreen
confidence: high
...
# GitHub. (2024). *GitHub Copilot Documentation*. GitHub Docs.

> [!definition] GitHub. (2024). *GitHub Copilot Documentation*. GitHub Docs.
...
```dataview
LIST FROM [[GitHub. (2024). GitHub Copilot Documentation. GitHub Docs]]
