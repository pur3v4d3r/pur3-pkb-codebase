---
title: "Communication Through Return Values"
aliases: []
type: permanent-note
status: evergreen
confidence: high
...
> [!definition] Communication Through Return Values
> *Definition pending — derived from 2 source report(s).*

## Core Explanation

> [!evidence] Communication Through Return Values
...
```dataview
LIST FROM [[Communication Through Return Values]]
