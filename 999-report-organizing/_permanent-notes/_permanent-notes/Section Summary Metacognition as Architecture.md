---
title: "Section Summary: Metacognition as Architecture"
aliases: []
type: permanent-note
status: evergreen
confidence: high
...
# Section Summary: Metacognition as Architecture

> [!definition] Section Summary: Metacognition as Architecture
...
```dataview
LIST FROM [[Section Summary Metacognition as Architecture]]
