---
title: "3. The Measurement of Cognitive Load — Methods, Instruments, and Validity"
aliases: []
type: permanent-note
status: evergreen
confidence: high
...
# 3. The Measurement of Cognitive Load — Methods, Instruments, and Validity

> [!definition] 3. The Measurement of Cognitive Load — Methods, Instruments, and Validity
> *Definition pending — derived from 2 source report(s).*

## Core Explanation

> [!evidence] 3. The Measurement of Cognitive Load — Methods, Instruments, and Validity
...
```dataview
LIST FROM [[3. The Measurement of Cognitive Load — Methods, Instruments, and Validity]]
