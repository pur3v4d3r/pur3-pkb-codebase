---
title: "SR Seed 4 — Distinction: Inline Suggestions vs. Copilot Chat"
aliases: []
type: permanent-note
status: evergreen
confidence: high
...
# SR Seed 4 — Distinction: Inline Suggestions vs. Copilot Chat

> [!definition] SR Seed 4 — Distinction: Inline Suggestions vs. Copilot Chat
...
```dataview
LIST FROM [[SR Seed 4 — Distinction Inline Suggestions vs. Copilot Chat]]
