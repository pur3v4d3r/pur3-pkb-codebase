---
title: "Van Rossum, G., & Drake, F. L. (2023). *The Python Tutorial*. Python Software Foundation."
aliases: []
type: permanent-note
status: evergreen
confidence: high
...
# Van Rossum, G., & Drake, F. L. (2023). *The Python Tutorial*. Python Software Foundation.

> [!definition] Van Rossum, G., & Drake, F. L. (2023). *The Python Tutorial*. Python Software Foundation.
...
```dataview
LIST FROM [[Van Rossum, G., & Drake, F. L. (2023). The Python Tutorial. Python Software Foundation]]
