...
# CORE IDENTITY
# ═══════════════════════════════════════════════════════════════════════════
title: "The schema-construction loop"
aliases:
...
see-also:
  ...
  - "[[fred-paas|Fred-Paas]]"
  - "[[kirschner-sweller-clark|Kirschner,-Sweller-&-Clark]]"
...
> [!definition] **The schema-construction loop** *(from [[cognitive-load-theory-element-interactivity-deep-dive-2026-04-20]])*
...
> [!analytical-insight] Key Insight *(from [[cognitive-load-theory-element-interactivity-deep-dive-2026-04-20]])*
...
> [!reflection] **Reflect** *(from [[cognitive-load-theory-element-interactivity-deep-dive-2026-04-20]])*
...
> [!far-transfer] **Method Transfer: Progressive Magnification as a Study Discipline** *(from [[cognitive-load-theory-element-interactivity-deep-dive-2026-04-20]])*
...
> [!example] **Worked Example: Counting elements in a syllogism vs. a vocabulary list** *(from [[cognitive-load-theory-element-interactivity-deep-dive-2026-04-20]])*
...
> 
> Task (a) presents twenty *independent* elements; the learner can process each pair separately, encode it, and move on. The element interactivity per item is essentially one (the word and its meaning, considered as a single paired association). Total load is *linear* in the number of…

> [!example] **Worked Example: The same material, three levels of element interactivity** *(from [[cognitive-load-theory-element-interactivity-deep-dive-2026-04-20]])*
...
> 
> **Conceptual level:** three entities (cat, dog, age), one action (chasing), one state (oldness), with a relational structure that requires the reader to track *which animal performs which role* despite the embedded clause. Here element interactivity is moderate — the embedded clause forces the reader to hold…

> [!example] **Worked Example: The trajectory of learning long division** *(from [[cognitive-load-theory-element-interactivity-deep-dive-2026-04-20]])*
...
> [!claude-insight] **Claude's perspective on the frontier** *(from [[cognitive-load-theory-element-interactivity-deep-dive-2026-04-20]])*
> What I find most consequential about the current frontier is that the questions are not minor refinements but *foundational reconceptualizations*. Whether element interactivity can be quantified, whether it has clean neural correlates, whether it integrates with broader architectures — the answers to these questions will reshape how CLT is taught, applied, and extended. The theory is at a point analogous to where many maturing fields find themselves: the practical tools work, the empirical findings replicate (mostly), but the theoretical foundations are visibly under construction. This is…

> [!claude-insight] **Claude's perspective on the speculative horizon** *(from [[cognitive-load-theory-element-interactivity-deep-dive-2026-04-20]])*
> What I find striking, at this most distant magnification level, is how *coherent* the picture remains as one zooms outward. The construct of element interactivity that began as a static property of material, was refined into a learner-relative property in interaction with schemas, was bounded by edge cases that revealed its conditions of validity, and has been pushed by frontier questions toward dynamic and computational reformulation, looks at the speculative horizon like a candidate to be absorbed into a much broader theory of how the brain manages the complexity of the world it tries to…

> [!claude-insight] **Specialist Recommendations for Continued Investigation** *(from [[cognitive-load-theory-element-interactivity-deep-dive-2026-04-20]])*
> For a serious investigator continuing to work in this area, several directions warrant priority. First, the measurement frontier (Frontier Question 1) is where the most consequential near-term progress is likely; investigators with quantitative or methodological skills can contribute disproportionately here. Second, the predictive-processing reformulation (Speculative Trajectory 1) offers the most promising theoretical horizon, but engaging it requires substantial investment in the predictive-processing literature outside CLT proper. Third, the relational-complexity-CLT integration (Frontier…

## Section Summaries

> [!section-summary] **Level 1 Summary** *(from [[cognitive-load-theory-element-interactivity-deep-dive-2026-04-20]])*
...
> [!section-summary] **Magnification Arc Summary** *(from [[cognitive-load-theory-element-interactivity-deep-dive-2026-04-20]])*
...
> [!diagram] **The Magnification Path** *(from [[cognitive-load-theory-element-interactivity-deep-dive-2026-04-20]])*
> ```
> ┌─────────────────────────────────────────────────────────┐
...
> [!diagram] **The Schema-Construction Loop (formal structure)** *(from [[cognitive-load-theory-element-interactivity-deep-dive-2026-04-20]])*
> ```
>      ┌────────────────────────────────────────────┐
...
> [!diagram] **Element-Interactivity at Multiple Grain Sizes** *(from [[cognitive-load-theory-element-interactivity-deep-dive-2026-04-20]])*
> ```
> ┌──────────────────────────────────────────────┐
...
> [!diagram] **Domain of Validity of the Standard Account** *(from [[cognitive-load-theory-element-interactivity-deep-dive-2026-04-20]])*
> ```
...
**Related concepts:**
[[cognitive-load-theory|Cognitive-Load-Theory]] · [[element-interactivity|Element-Interactivity]] · [[expertise-reversal-effect|Expertise-Reversal-Effect]] · [[germane-cognitive-load|Germane-Cognitive-Load]] · [[element-interactivity|Element-Interactivity]] · [[cognitive-load-theory|Cognitive-Load-Theory]] · [[john-sweller|John-Sweller]] · [[fred-paas|Fred-Paas]] · [[kirschner-sweller-clark|Kirschner,-Sweller-&-Clark]] · [[multimedia-learning-theory|Multimedia-Learning-Theory]] · [[cognitive-architecture-working-memory-long-term-memory|Cognitive-Architecture-Working-Memory-&-Long-Term-Memory]] · [[worked-example-effect|Worked-Example-Effect]] · [[split-attention-effect|Split-Attention-Effect]] · [[modality-effect|Modality-Effect]] · [[redundancy-effect|Redundancy-Effect]] · [[cognitive-load-theory|Cognitive-Load-Theory]] · [[cognitive-load-theory|Cognitive-Load-Theory]] · [[working-memory|Working-Memory]] · [[intrinsic-cognitive-load|Intrinsic-Cognitive-Load]] · [[extraneous-cognitive-load|Extraneous-Cognitive-Load]] · [[germane-cognitive-load|Germane-Cognitive-Load]] · [[schema-construction|Schema-Construction]] · [[worked-example-effect|Worked-Example-Effect]] · [[split-attention-effect|Split-Attention-Effect]] · [[modality-effect|Modality-Effect]] · [[redundancy-effect|Redundancy-Effect]] · [[educational-psychology|Educational-Psychology]] · [[element-interactivity|Element-Interactivity]] · [[cognitive-load-theory|Cognitive-Load-Theory]] · [[working-memory|Working-Memory]]

## Methodology Notes

> [!methodology-and-sources] **Scope Statement** *(from [[cognitive-load-theory-element-interactivity-deep-dive-2026-04-20]])*
...
> 
> **What this report covers:** the construct of element interactivity itself; how it generates intrinsic load; what counts as an element and what counts as an interaction; how expertise transforms the count; the edge cases that complicate the construct (biologically primary knowledge,…

---

## Source Attribution

**Extracted from:** [[cognitive-load-theory-element-interactivity-deep-dive-2026-04-20]]
