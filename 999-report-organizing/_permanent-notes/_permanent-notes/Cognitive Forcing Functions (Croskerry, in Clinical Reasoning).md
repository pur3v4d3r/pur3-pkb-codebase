---
title: "Cognitive Forcing Functions (Croskerry, in Clinical Reasoning)"
aliases: []
type: permanent-note
status: evergreen
confidence: high
...
# Cognitive Forcing Functions (Croskerry, in Clinical Reasoning)
...
```dataview
LIST FROM [[Cognitive Forcing Functions (Croskerry, in Clinical Reasoning)]]
