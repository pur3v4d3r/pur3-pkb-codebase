---
title: "Why does the 4C/ID model use a whole-task approach rather than part-task decomposition?"
aliases: []
type: permanent-note
status: evergreen
confidence: high
...
# Why does the 4C/ID model use a whole-task approach rather than part-task decomposition?

> [!definition] Why does the 4C/ID model use a whole-task approach rather than part-task decomposition?
...
```dataview
LIST FROM [[Why does the 4CID model use a whole-task approach rather than part-task decomposition]]
