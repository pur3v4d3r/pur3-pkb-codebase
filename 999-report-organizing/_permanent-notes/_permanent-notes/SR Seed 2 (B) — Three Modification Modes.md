---
title: "SR Seed 2 (B) — Three Modification Modes"
aliases: []
type: permanent-note
status: evergreen
confidence: high
...
# SR Seed 2 (B) — Three Modification Modes

> [!definition] SR Seed 2 (B) — Three Modification Modes
...
```dataview
LIST FROM [[SR Seed 2 (B) — Three Modification Modes]]
