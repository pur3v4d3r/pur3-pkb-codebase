---
title: "Coordination-Simplicity-Principle"
aliases: []
type: permanent-note
status: evergreen
confidence: high
...
# Coordination-Simplicity-Principle
...
> [!evidence] Coordination-Simplicity-Principle
> Markdown files as coordination mechanism outperform complex orchestration frameworks for most use cases because they're human-readable, version-controllable, easily debuggable, and don't require additional infrastructure; the simplest solution that works is often the best solution.
...
```dataview
LIST FROM [[Coordination-Simplicity-Principle]]
