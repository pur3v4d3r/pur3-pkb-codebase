---
title: "Tension 2: Mechanism Specificity vs. Domain Generality"
aliases: []
type: permanent-note
status: evergreen
confidence: high
...
# Tension 2: Mechanism Specificity vs. Domain Generality

> [!definition] Tension 2: Mechanism Specificity vs. Domain Generality
> *Definition pending — derived from 2 source report(s).*

## Open Threads

> [!tension-identified] Tension 2: Mechanism Specificity vs. Domain Generality
...
```dataview
LIST FROM [[Tension 2 Mechanism Specificity vs. Domain Generality]]
