---
title: "Insight Transfer 2: The schema-construction loop in self-directed learning and PKM"
aliases: []
type: permanent-note
status: evergreen
confidence: medium
...
# Insight Transfer 2: The schema-construction loop in self-directed learning and PKM

> [!definition] Insight Transfer 2: The schema-construction loop in self-directed learning and PKM
> *Definition pending — derived from 1 source report(s).*

## Core Explanation

> [!evidence] Insight Transfer 2: The schema-construction loop in self-directed learning and PKM
...
```dataview
LIST FROM [[Insight Transfer 2 The schema-construction loop in self-directed learning and PKM]]
