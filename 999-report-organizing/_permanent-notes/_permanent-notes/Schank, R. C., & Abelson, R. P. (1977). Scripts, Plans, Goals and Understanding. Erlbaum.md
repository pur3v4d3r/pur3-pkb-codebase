---
title: "Schank, R. C., & Abelson, R. P. (1977). *Scripts, Plans, Goals and Understanding*. Erlbaum."
aliases: []
type: permanent-note
status: evergreen
confidence: high
...
> [!definition] Schank, R. C., & Abelson, R. P. (1977). *Scripts, Plans, Goals and Understanding*. Erlbaum.
...
```dataview
LIST FROM [[Schank, R. C., & Abelson, R. P. (1977). Scripts, Plans, Goals and Understanding. Erlbaum]]
