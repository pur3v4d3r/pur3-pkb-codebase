---
title: "Specialist Pitfall: Effect-List Thinking"
aliases: []
type: permanent-note
status: evergreen
confidence: high
...
# Specialist Pitfall: Effect-List Thinking

> [!definition] Specialist Pitfall: Effect-List Thinking
...
```dataview
LIST FROM [[Specialist Pitfall Effect-List Thinking]]
