---
title: "When NOT to Use Parallel Execution"
aliases: []
type: permanent-note
status: evergreen
confidence: high
...
> [!definition] When NOT to Use Parallel Execution
> *Definition pending — derived from 2 source report(s).*

## Core Explanation

> [!evidence] When NOT to Use Parallel Execution
...
```dataview
LIST FROM [[When NOT to Use Parallel Execution]]
