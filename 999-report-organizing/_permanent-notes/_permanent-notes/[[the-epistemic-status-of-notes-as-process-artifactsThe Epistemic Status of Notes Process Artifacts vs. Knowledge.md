---
title: "[[the-epistemic-status-of-notes-as-process-artifacts|The Epistemic Status of Notes: Process Artifacts vs. Knowledge Objects]]"
aliases: []
type: permanent-note
status: evergreen
confidence: high
...
# [[the-epistemic-status-of-notes-as-process-artifacts|The Epistemic Status of Notes: Process Artifacts vs. Knowledge Objects]]

> [!definition] [[the-epistemic-status-of-notes-as-process-artifacts|The Epistemic Status of Notes: Process Artifacts vs. Knowledge Objects]]
> *Definition pending — derived from 2 source report(s).*

## Core Explanation

> [!evidence] [[the-epistemic-status-of-notes-as-process-artifacts|The Epistemic Status of Notes: Process Artifacts vs. Knowledge Objects]]
...
```dataview
LIST FROM [[[[the-epistemic-status-of-notes-as-process-artifactsThe Epistemic Status of Notes Process Artifacts vs. Knowledge]]
