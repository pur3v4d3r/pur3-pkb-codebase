---
title: "Tension 4: Schema-as-Unit vs. Schema-as-Family-Resemblance"
aliases: []
type: permanent-note
status: evergreen
confidence: high
...
# Tension 4: Schema-as-Unit vs. Schema-as-Family-Resemblance

> [!definition] Tension 4: Schema-as-Unit vs. Schema-as-Family-Resemblance
> *Definition pending — derived from 2 source report(s).*

## Core Explanation

> [!evidence] Tension 4: Schema-as-Unit vs. Schema-as-Family-Resemblance
...
```dataview
LIST FROM [[Tension 4 Schema-as-Unit vs. Schema-as-Family-Resemblance]]
