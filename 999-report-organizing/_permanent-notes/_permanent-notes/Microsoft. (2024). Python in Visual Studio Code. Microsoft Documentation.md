---
title: "Microsoft. (2024). *Python in Visual Studio Code*. Microsoft Documentation."
aliases: []
type: permanent-note
status: evergreen
confidence: high
...
# Microsoft. (2024). *Python in Visual Studio Code*. Microsoft Documentation.

> [!definition] Microsoft. (2024). *Python in Visual Studio Code*. Microsoft Documentation.
...
```dataview
LIST FROM [[Microsoft. (2024). Python in Visual Studio Code. Microsoft Documentation]]
