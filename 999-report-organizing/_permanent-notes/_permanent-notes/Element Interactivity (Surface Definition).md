---
title: "Element Interactivity (Surface Definition)"
aliases: []
type: permanent-note
status: evergreen
confidence: high
...
# Element Interactivity (Surface Definition)
...
> [!evidence] Element Interactivity (Surface Definition)
> [**Element-Interactivity**:: The number of information elements that must be simultaneously processed in working memory for understanding to occur. Conventionally treated as the determinant of intrinsic cognitive load.]
...
```dataview
LIST FROM [[Element Interactivity (Surface Definition)]]
