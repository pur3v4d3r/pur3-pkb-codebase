---
title: "Protocol 3: Worked Example → Faded Guidance"
aliases: []
type: permanent-note
status: evergreen
confidence: high
...
# Protocol 3: Worked Example → Faded Guidance

> [!definition] Protocol 3: Worked Example → Faded Guidance
...
```dataview
LIST FROM [[Protocol 3 Worked Example → Faded Guidance]]
