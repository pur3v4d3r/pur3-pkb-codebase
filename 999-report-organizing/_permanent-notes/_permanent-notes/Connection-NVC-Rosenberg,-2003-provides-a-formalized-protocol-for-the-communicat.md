...
# CORE IDENTITY
# ═══════════════════════════════════════════════════════════════════════════
title: "*Connection:* NVC (Rosenberg, 2003) provides a formalized protocol for the communication practices t"
aliases:
  - "*Connection"
  - "*Connection:* NVC (Rosenberg, 2003) provides a formalized protocol for the communication practices t"
type: permanent-note
status: seedling
confidence: low
...
> [!definition] ***Connection:* NVC (Rosenberg, 2003) provides a formalized protocol for the communication practices t**
