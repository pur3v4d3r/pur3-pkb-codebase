---
title: "[[worked-example-effect|The Worked Example Effect]]: Mechanisms, Moderators, and Design Principles"
aliases: []
type: permanent-note
status: evergreen
confidence: high
...
# [[worked-example-effect|The Worked Example Effect]]: Mechanisms, Moderators, and Design Principles

> [!definition] [[worked-example-effect|The Worked Example Effect]]: Mechanisms, Moderators, and Design Principles
> *Definition pending — derived from 1 source report(s).*

## Core Explanation

> [!evidence] [[worked-example-effect|The Worked Example Effect]]: Mechanisms, Moderators, and Design Principles
...
```dataview
LIST FROM [[[[worked-example-effectThe Worked Example Effect]] Mechanisms, Moderators, and Design Principles]]
