---
title: "Metacognitive Superiority Effect"
aliases: []
type: permanent-note
status: evergreen
confidence: high
...
# Metacognitive Superiority Effect

> [!definition] Metacognitive Superiority Effect
> *Definition pending — derived from 2 source report(s).*

## Core Explanation

> [!evidence] Metacognitive Superiority Effect
...
```dataview
LIST FROM [[Metacognitive Superiority Effect]]
