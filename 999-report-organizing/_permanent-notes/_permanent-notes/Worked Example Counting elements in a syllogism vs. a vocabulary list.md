---
title: "Worked Example: Counting elements in a syllogism vs. a vocabulary list"
aliases: []
type: permanent-note
status: evergreen
confidence: medium
...
# Worked Example: Counting elements in a syllogism vs. a vocabulary list

> [!definition] Worked Example: Counting elements in a syllogism vs. a vocabulary list
...
```dataview
LIST FROM [[Worked Example Counting elements in a syllogism vs. a vocabulary list]]
