---
title: "Expert Debate 2: Should germane load be retained as a third source?"
aliases: []
type: permanent-note
status: evergreen
confidence: medium
...
# Expert Debate 2: Should germane load be retained as a third source?

> [!definition] Expert Debate 2: Should germane load be retained as a third source?
> *Definition pending — derived from 1 source report(s).*

## Core Explanation

> [!evidence] Expert Debate 2: Should germane load be retained as a third source?
...
```dataview
LIST FROM [[Expert Debate 2 Should germane load be retained as a third source]]
