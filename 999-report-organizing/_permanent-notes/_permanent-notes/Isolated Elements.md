...
> [!evidence] Isolated Elements
> [**Isolated-Elements**:: Elements that can be learned independently of one another, without reference to other elements. Each element can be processed serially in working memory, one at a time. Example: Vocabulary items in a foreign language, where knowing the word for "cat" does not require simultaneously knowing the word for "dog."]
> *— [[cognitive-load-theory-deep-dive-2026-04-12_report]]*

> [!evidence] Isolated-Elements
> Elements that can be learned independently of one another, without reference to other elements. Each element can be processed serially in working memory, one at a time. Example: Vocabulary items in a foreign language, where knowing the word for "cat" does not require simultaneously knowing the word for "dog."
> *— [[cognitive-load-theory-deep-dive-2026-04-12_report]]*
