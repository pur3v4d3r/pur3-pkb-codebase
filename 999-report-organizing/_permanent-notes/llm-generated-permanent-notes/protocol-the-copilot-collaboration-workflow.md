...
aliases:
- copilot workflow
- GitHub Copilot collaboration process
...
> Protocol: The Copilot Collaboration Workflow is a set of guidelines for integrating AI-generated code into projects using Copilot in VS Code, emphasizing clear intent comments, immediate reading and verification, test case validation, confident modification, and explanatory comments.
