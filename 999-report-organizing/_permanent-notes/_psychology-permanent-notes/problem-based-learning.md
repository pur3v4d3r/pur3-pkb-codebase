...
At its core, PBL inverts the conventional content-then-application sequence by treating the problem itself as the curriculum-organizing unit. Students identify what they know and need to learn to solve the problem, thereby acquiring knowledge that is organized around problem schemas rather than topical hierarchies.

In practice, PBL operates through a structured process where students are guided by tutors or facilitators who help them navigate the problem-solving journey. This approach encourages critical thinking, collaboration, and self-directed learning as students work to find solutions and deepen their understanding of relevant concepts.
...
The mechanism of PBL involves a step-by-step process where students first identify the problem, then brainstorm potential solutions, research necessary information, and finally implement their solution. This iterative process helps students develop critical thinking skills and learn how to apply knowledge in practical contexts.

## Practical Implications

> [!example] **Application 1 — Instructional design**
> In instructional design, PBL can be used to create engaging and interactive learning experiences that promote deep understanding. By focusing on real-world problems, educators can design curricula that are both relevant and challenging, encouraging students to apply their knowledge in meaningful ways.

> [!example] **Application 2 — Classroom management**
> In classroom settings, PBL requires careful planning and facilitation to ensure all students participate effectively. Teachers must balance group dynamics, provide necessary resources, and guide students through the problem-solving process without giving away answers, which can be challenging but rewarding.

> [!example] **Application 3 — Assessment**
> PBL necessitates alternative assessment methods that evaluate not just factual knowledge but also critical thinking, collaboration, and problem-solving skills. Rubrics and portfolios become essential tools for assessing student progress throughout the PBL process.
...
> How can PBL be effectively scaled to large classrooms?
>
> *What would resolve it:* Further research is needed to develop scalable models of PBL that maintain the benefits of small-group collaboration while accommodating larger class sizes and diverse learning needs.

> [!open-question] **Question**
> What are the long-term effects of PBL on student learning and career readiness?
>
...
Empirical evidence supports PBL's effectiveness in enhancing clinical-reasoning and process-skill outcomes, particularly when expert tutor support is provided. However, its impact on factual knowledge remains mixed, suggesting that a balanced approach combining PBL with direct instruction may be most effective.
