...
> [!abstract] **Diagram 1 — Affordances Interaction Model**
> *Follow the flow from environment to action through affordances.*
>
> ```mermaid
> graph TD
>   A[Environment] --> B[Affordance]
>   B --> C[Perception]
>   C --> D[Action]
> ```


> [!abstract] **Diagram 2 — Optic Flow Process**
> *Trace the process from optic flow to spatial navigation.*
>
> ```mermaid
> flowchart LR
>   A[Optic Flow] --> B[Motion Cues]
>   B --> C[Spatial Relationships]
>   C --> D[Navigation]
> ```


> [!abstract] **Diagram 3 — Direct Perception Mechanism**
> *Observe the direct interaction between environment and perception.*
>
> ```mermaid
> graph TD
>   A[Environment] --> B[Sensory Input]
>   B --> C[Perception]
>   C --> D[Action]
> ```
...
Ecological Psychology fundamentally challenges traditional views by asserting that perception is not a process of constructing internal representations but rather a direct pickup of information from the environment. Gibson introduced the concept of 'affordances,' which are the possibilities for action provided by an object or environment in relation to an individual's needs and abilities. For instance, a chair affords sitting, and a door affords opening. This theory emphasizes that perception is not about interpreting sensory data but about directly perceiving what actions can be performed within the given context.
...
> In instructional design, ecological psychology suggests that learning environments should be designed to provide direct sensory feedback. For example, interactive simulations can offer immediate visual and auditory cues about the consequences of actions, enhancing learners' ability to perceive affordances and adapt their behavior accordingly.

> [!example] **Application 2 — Robotics**
> In robotics, ecological psychology informs the development of robots that can navigate environments by directly perceiving affordances. This approach allows robots to perform tasks more efficiently without relying on complex internal models or symbolic reasoning.
...
- **James J. Gibson** — Gibson is the founder of Ecological Psychology, introducing the concepts of direct perception and affordances to challenge traditional cognitive theories and emphasizing the importance of sensory input in understanding the environment.

## Open Questions

> [!open-question] **Question**
> How does Ecological Psychology account for off-line cognition?
>
> *What would resolve it:* Further research is needed to explore how ecological principles can be applied to tasks that are not tightly coupled with immediate perception and action, such as planning or problem-solving in the absence of direct sensory input.

> [!open-question] **Question**
> Can Ecological Psychology be applied to symbolic reasoning?
>
