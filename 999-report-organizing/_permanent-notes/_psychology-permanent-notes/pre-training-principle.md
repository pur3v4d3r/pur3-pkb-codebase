...
The Pre-Training Principle operates on the idea that learners can be better prepared for main instruction if they are first introduced to the key components of a topic. This initial exposure shifts intrinsic load—such as vocabulary and feature recognition—to a preparatory phase, allowing working memory to focus more effectively during the main lesson on integrating cause-and-effect relations.

In practice, this principle is applied by educators who provide brief pre-training sessions before delving into detailed explanations. For instance, in teaching complex scientific concepts like photosynthesis, instructors might first introduce students to key terms and features of plant cells, such as chloroplasts and stomata, before explaining the process step-by-step.

Theoretical roots of this principle can be traced back to cognitive load theory, which posits that working memory has limited capacity. By reducing intrinsic load through pre-training, learners are better equipped to handle extraneous and germane loads during main instruction, leading to more effective learning transfer.
...
> In instructional design, pre-training can be used to introduce students to key terms and concepts before a detailed explanation. For example, in teaching algebra, instructors might first define variables, constants, and equations through brief pre-training sessions, enabling students to focus on problem-solving techniques during the main lesson.

> [!example] **Application 2 — Language learning**
> In language learning contexts, pre-training can help learners familiarize themselves with new vocabulary before engaging in more complex grammatical structures. This approach ensures that working memory is not overloaded with unfamiliar terms, allowing for better comprehension and retention of the target language.
...
- **John Sweller** — John Sweller is credited with originating the Pre-Training Principle in his work on cognitive load theory. His research highlighted the importance of reducing intrinsic load through preparatory phases to enhance learning efficiency.

## Open Questions

> [!open-question] **Question**
> How does the duration of pre-training affect learning outcomes?
>
> *What would resolve it:* Further empirical studies could explore optimal durations for pre-training sessions, determining whether shorter or longer periods yield better learning outcomes.

> [!open-question] **Question**
> Can pre-training be applied to all types of complex material?
>
