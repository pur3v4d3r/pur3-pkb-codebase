...
>   subgraph Insurance
>     A -->|Willing to pay premiums for small chance of avoiding large losses|
>   end
>   subgraph Investment Decisions
>     C -->|Avoid high-risk investments despite higher potential returns|
>   end
>   subgraph Policymaking
>     E -->|Automatic enrollment in retirement plans with opt-out provisions|
>   end
> ```
