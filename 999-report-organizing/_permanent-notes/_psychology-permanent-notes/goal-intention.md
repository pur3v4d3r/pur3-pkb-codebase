...
> *Follow the flow from goal intention to implementation intention.*
>
> ```mermaid
> flowchart LR
>   A[Goal Intention] --> B[Preplanning]
>   B --> C[Implementation Intention]
>   C --> D[Action]
> ```


> [!abstract] **Diagram 2 — Cognitive Pre-compilation Analogy**
> *Compare the flexibility and execution overhead of goal intentions vs. implementation intentions.*
>
> ```mermaid
> graph TD
>   A[Goal Intention] -->|High-level, flexible| B[Implementation Intention]
>   A -->|Slow to execute| C[Cognitive Overhead]
>   B -->|Less flexible| D[Minimal Execution Overhead]
> ```
...
Implementation intentions represent a strategic preplanning phase in the action phase model, bridging the gap between goal intentions and actual behavior. They are formulated as 'When X occurs, I will Y,' where X is a specific situational cue and Y is the intended response. This format allows for the automatic execution of planned behaviors without requiring continual deliberation, making them particularly effective in reducing intention-behavior gaps.

Consider a graduate student who has formed the goal intention to read more philosophy of mind this semester. While this intention represents successful crossing into the postdecisional phase and the initiation of an implemental mindset, it does not specify when, where, or in response to what cue the reading will actually occur. Adding 'When I sit down at my desk after morning coffee, I will open C...' transforms a vague goal into a concrete implementation intention that can be executed automatically.

The Rubicon Model parses goal pursuit into four phases: deliberation, preplanning, action, and evaluation. Implementation intentions are situated at the transition from preplanning to action, where they confer cognitive economy by exempting committed actions from continual re-deliberation. This strategic planning allows for efficient execution of intended behaviors without the need for repeated decision-making.
...
> In instructional design, implementation intentions can be used to enhance student engagement and learning outcomes. For example, a teacher might instruct students to 'When I hear the bell ring at 3 PM, I will immediately start working on my homework.' This specific plan helps students automatically transition into study mode without needing additional motivation or deliberation.

> [!example] **Application 2 — Health behavior change**
> In health behavior change, implementation intentions can be applied to encourage healthier habits. For instance, a smoker might formulate 'When I feel the urge to smoke after lunch, I will take a walk instead.' This plan helps reduce the intention-behavior gap by providing a clear and automatic response to a specific cue.
...
- **Peter M. Gollwitzer** — Peter M. Gollwitzer is credited with originating the concept of implementation intentions in his seminal works from 1993 and 1999, providing a foundational framework for understanding how specific plans can bridge the gap between goal intentions and actual behavior.

## Open Questions

> [!open-question] **Question**
> How can implementation intentions be effectively integrated into educational settings?
>
> *What would resolve it:* Further research on the long-term effects of using implementation intentions in various educational contexts would help clarify their effectiveness and provide guidelines for integration.
