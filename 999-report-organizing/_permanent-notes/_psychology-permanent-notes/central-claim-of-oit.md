...
The four extrinsic regulatory styles—external regulation, introjection, identification, and integration—are not points along a single dimension of 'amount of internalization' but are qualitatively distinct architectures of regulation. External regulation involves contingency at a distance, where the individual is regulated by external forces without personal endorsement. Introjection occurs when individuals take this contingency inside themselves but do not fully endorse it. Identification marks the stage where the individual endorses the value served by the regulation and integrates it with their self-concept. Integration represents the highest level of regulation, where the endorsed values are coherently organized into one's overall identity.

These regulatory styles operate in a developmental sequence, each being a precondition for the next. For instance, external regulation is necessary before introjection can occur, as individuals must first experience and internalize the contingency before fully endorsing it. Identification follows when the individual not only endorses but also actively seeks to fulfill the regulated goals. Integration then emerges when these endorsed values are seamlessly integrated into one's self-concept, leading to a more autonomous form of regulation.

The functional significance of each regulatory style lies in its relationship with the person and the regulation. External regulation is characterized by external control and lack of personal endorsement, while introjection involves internalizing but not fully embracing the regulation. Identification marks a shift towards personal endorsement and active engagement, whereas integration signifies a deep, coherent organization of values within one's self-concept.
...
> In instructional design, understanding the different regulatory styles can help educators create environments that promote higher levels of identification and integration. For instance, providing students with opportunities to set their own goals and reflect on how these align with their personal values can foster identification. Integrating activities that require students to apply new knowledge in real-world contexts can further support this process.
...
- **Edward L. Deci** — Edward L. Deci is a key contributor to the development of Overlapping Integrative Theory (OIT). He has extensively researched and theorized about the different regulatory styles, emphasizing their qualitative differences rather than a linear progression in internalization.

## Open Questions

> [!open-question] **Question**
> How does the integration style differ from other regulatory styles?
>
> *What would resolve it:* Further empirical research comparing the psychological outcomes and motivational patterns associated with each regulatory style could help clarify the unique characteristics of integration.
