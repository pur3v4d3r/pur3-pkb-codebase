...
- Gap 2: I would like to develop further understanding of how [[attribution-theory]] vocabulary can affect [[self-efficacy]], and [[achievement-goal-theory|setting attainable goals]].
...
- I expect tension with [[attribution-theory]] around the issue of developing the proper vocabulary to puposefully build [[self-efficacy]].
...
> I can explain what types of language to use for building [[self-efficacy]], using [[attribution-theory]] to produce goal alighned with the startegies explained in the report.
