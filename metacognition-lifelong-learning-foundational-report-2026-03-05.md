...
[[Metacognition]] — the capacity to think about one's own thinking — is the cognitive capacity that resolves this asymmetry. It is, in the words of [[John Flavell]], who introduced the term in 1979, "knowledge and cognition about cognitive phenomena." When you pause mid-reading to notice that you have not understood a paragraph and re-read it, that is metacognition. When you decide to explain a concept to a friend because you know that teaching accelerates your own understanding, that is metacognition. When you realize that you have been highlighting text for an hour without actually retaining anything, and then switch strategies, that too is metacognition.
...
[[Lifelong learning]] — the sustained, voluntary pursuit of knowledge and competence across the entire lifespan — is the domain in which metacognitive capacity becomes most consequential. The early twentieth century image of education as a discrete, bounded period culminating in a credential has been rendered obsolete by technological acceleration, career volatility, and the expanding timespan of healthy adult life. A person who completes formal education at twenty-two may reasonably expect four or five distinct career phases and fifty or more additional years of professional development. The quality of that development depends heavily not on what they learned in school, but on how well they learned to learn.
...
A crucial distinction that later researchers refined is between **[[declarative metacognitive knowledge]]** (knowing *that* — e.g., "I know that I learn better in the morning"), **[[procedural metacognitive knowledge]]** (knowing *how* — e.g., knowing how to use a self-testing strategy), and **[[conditional metacognitive knowledge]]** (knowing *when and why* — e.g., understanding that the self-testing strategy is most valuable when dealing with factual material that requires durable retention). This tripartite structure of metacognitive knowledge is important because it explains why knowing that a strategy exists is insufficient to use it well — procedural and conditional knowledge must accompany declarative knowledge for effective regulation.
...
*Report generated by [[Foundational Report Generator v1.0]] · 2026-03-05 · [[Claude Sonnet 4.6]]*
