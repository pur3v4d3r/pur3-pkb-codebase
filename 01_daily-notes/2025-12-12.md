...
link-related:
  - "[[2025-12-11|Yesterday's Daily Note]]"
---
### *Daily Quote's*
...
## Friday, December 12th, 2025's Plan
### Tasks Overview
...
- **Prospective Visualization**: 
	- [What challenges might today present?]
		- Anxiety and Staying focused/getting back into the swing of things.
	- [How do I want to respond?] 
			- I plan to respond to these challenges [ANXIETY AND FOCUS] with the [[Dichotomy of Control|Stoic Dichotomy of Control]], and through acceptance of the fact that something's are not within your control.
...
- **Tomorrow's Commitment**: 
	- [Based on today's reflection, what specific intention will I set for tomorrow?]
		- [ ] {{PRIORITY TOMORROW HERE}} [scheduled:: 2025-12-13] [created:: 2025-12-12]
...
> ⌛**Time**:: 19:02:57PM
> 🆔**ID**:: 20251212190257
> 🖥️**Log-Entry**:: start of the day after no medicine for a week.
