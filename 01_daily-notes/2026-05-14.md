...
- **Goal Progress** — Where are you relative to this morning's goals?
	- Goal 1 status: Not started / In progress / Complete -> Complete
	- Goal 2 status: Not started / In progress / Complete -> Complete

- **Strategy Fidelity** — Are you actually using the strategy you planned, or have you drifted?
	- Still on strategy? Yes / No -> Yes
...
- **Attention Quality** — Rate your focus since this morning (1–10). What has captured most of your attention — is it what you intended?
	- Focus rating: `7/10`
	- Primary attention target (actual): Focused on Reading

- **Cognitive Load Signal** — Are you experiencing overload (too many demands), underload (boredom), or flow?
	- State: Overloaded / Underloaded / In flow -> Flow
	- One adjustment to make this afternoon: Keep Reading and Walking
...
- **Event Documentation**:
	- What significant events occurred?
		- Factual recording (no judgment yet): -> Managed to stay up for entire day.

- **Judgment Analysis**:
	- What interpretations/judgments did I make today? -> Started The Universe Permanent notes.
