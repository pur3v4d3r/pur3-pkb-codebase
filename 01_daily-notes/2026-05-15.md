...
- **Prospective Visualization**:
	- What challenges might today present? -> Staying awake past 9:00AM.
	- How do I want to respond? -> By taking medicine/caffine, and walking/reading until they have started to work.
...
- **Virtue Intention**:
	- Which specific virtue will I emphasize today?
		...
		- [x] Temperance — moderate impulses

- **Control Dichotomy**:
	- Within my control today: -> How and how long I read for.
	- Outside my control today (acceptance): -> Whether or not I have anxiety.

- **Implementation Intentions**:
	- If [it is 8:00-9:00AM, and Im tired], then I will [take caffine/medicine and walk until it starts to work].
...
- **Goal Specification** — State today's primary learning/work goal with enough precision that you'll know at day's end whether you achieved it:
	- Goal 1: -> Read the report [[designing-pkb-metacognitive-scaffolds-for-studying-foundational-report-2026-05-15]].
	- Goal 2: -> Stay awake past 11:00AM.
...
- **Strategy Selection** — What specific approach will you use to reach each goal? Why this strategy over alternatives?
	...
	- Strategy for Goal 2: -> Taking caffine/medicine and walking/reading until it starts to work.
...
- **Cognitive Resource Audit** — What is your current mental state? Assess *before* allocating your hardest work:
	...
	- Best time window for deep work today: -> 3:00Am+
...
- **Anticipated Obstacles** — What is the single most likely thing that will derail today's goals? What is your pre-commitment response?
	...
	- Pre-commitment response (if X happens, I will Y): -> If [it is 8:00-9:00AM, and Im tired], then I will [take caffine/medicine and walk until it starts to work].
...
- **Tomorrow's Commitment**:
	- Based on today's reflection, what specific intention will you set for tomorrow?
		- [ ] {{PRIORITY TOMORROW HERE}} [scheduled:: 2026-05-16] [created:: 2026-05-15]
