---
title: "Comprehensive Reference: Mastering Life-long Self-directed Learning"
id: 20251112-205935
type: reference
status: seedling
rating: ""
source: claude-4.5-sonnet
url: https://claude.ai/chat/c80ced22-a3b9-4783-bd7e-4ad46343d6d5
tags:
  - year/2025
  - status/seedling
  - project/pur3v4d3r
...
link-up:
  - "[[composite_prompt_claude_comprehensive-reference-on-cognitive-improvements_v1]]"
link-related: []
---
...
```mermaid
graph LR
    A[Sensory Input] -->|Attention| B[Working Memory]
    B -->|Encoding| C[Long-Term Memory]
    C -->|Retrieval| B
    B -->|Forgetting| D[Lost]
    C -->|Interference/Decay| D
```
