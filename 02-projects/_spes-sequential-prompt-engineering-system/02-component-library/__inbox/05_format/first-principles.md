---
title: 🧱First Principle Scaffold
id: 20251030200149
aliases:
  ...
  - Deconstruction
type: component
created: 2025-10-30T20:01:49
url: "[[gemini-prompt-components]]"
tags:
  - prompt-component-library
  - component/type/scaffold
description: This framework provides a structured approach for generating long-form articles that deconstruct common knowledge to its fundamental truths, challenging assumptions and building new, optimized understandings from first principles.
---
...
> [!quick-reference]
> 
> - **Purpose**:: To offer a template for creating in-depth analyses that rigorously question established beliefs, identify core principles, and provide innovative solutions based on fundamental truths.
>   
> - **Category**:: `Logic & Thinking`
>   
> - **When to Use**:: When generating long-form content that requires a deep examination of a topic, aiming to challenge assumptions, uncover first principles, and build new understandings.

## ⚙️ First-Principles Structural Scaffolding

```component
---
id: prompt-block-🆔20251030200140
---
...
> [!description]
> 
> This structural scaffolding outlines a first-principles approach to content creation. It begins with deconstructing common knowledge, identifying first principles, reconstructing a new solution, and analyzing the rebuilt model. The framework uses specific callouts, questions, and sections to ensure a comprehensive, insightful, and innovative analysis.

> [!use-cases-and-examples]
>  
>  - **Best For**:: Creating content that challenges conventional wisdom and promotes innovative thinking.
>    
>  - **Best For**:: Providing a structured approach for solving complex problems by breaking them down to their fundamental truths.

> [!constraints-and-pitfalls]
>
>   - **When *not* to use**:: When generating content that requires a straightforward presentation of facts or a purely descriptive account without challenging underlying assumptions.
>     
>   - **Potential Conflict**:: May conflict with components that prioritize established knowledge over fundamental truths or that do not align with a first-principles methodology.
