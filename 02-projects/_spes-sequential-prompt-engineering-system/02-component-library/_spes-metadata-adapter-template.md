...
- [ ] **⚠️ AVOID Dataview inline queries INSIDE callouts** (causes Obsidian freezing)

> [!warning] Performance Issue: Dataview Inline Queries in Callouts
> **DO NOT** use Dataview inline query syntax (`=this.fieldname`) **inside Obsidian callouts** (`> [!type]`). Multiple inline queries within callouts cause Obsidian to freeze during render.
>
> **❌ WRONG** (causes freezing):
>
> ```markdown
> > [!info]
...
> ```
>
> **✅ CORRECT** (static values in callouts, or queries outside callouts):
>
> ```markdown
> > [!info]
> > **Version**: 2.0.0
...
> ```
>
> Inline queries work fine in regular text, just not inside callout blocks.

---

## 🎯 Example: Atomic Instruction Component
...
## 🎯 Example: Composite Workflow Component
