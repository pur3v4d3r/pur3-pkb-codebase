...
Each framework offers valuable lenses, but the cognitive overhead of consciously coordinating them is substantial. Evidence from [[Cognitive Load Theory (CLT)]] research suggests that when intrinsic task complexity is high (as in complex socioeconomic reasoning), additional extraneous load (framework coordination) pushes learners toward cognitive overload, impairing rather than enhancing performance.
