...
HSL hue rotation to transform all red-family accent colors to **Navy**.
...
### Theme
1. Copy the `V4D3R Navy` folder (containing `theme.css`, `manifest.json`,
   and this `README.md`) into your vault's `.obsidian/themes/` directory.
2. In Obsidian: Settings → Appearance → Themes → Select **V4D3R Navy**.
