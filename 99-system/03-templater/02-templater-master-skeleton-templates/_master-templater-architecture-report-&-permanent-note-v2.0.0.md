...
## 📝 Cheatsheet: All Available Groups
...
### Templater Tag Selection Arrays in [[_master-templater-architecture-report-&-permanent-note-v2.0.0]]
...
```
const tag6 = await tp.system.suggester(groupC1_Display, groupC1_Tags.sort(), false, "TAG 6 - Sub-Domain: PKM/PKB");
const tag7 = await tp.system.suggester(groupC2_Display, groupC2_Tags.sort(), false, "TAG 7 - Sub-Domain: Cognitive");
...
## Working out the Templater Logic (*Tag Selection Process*)
...
const tag9 = await tp.system.suggester(groupC1_Display, groupC1_Tags.sort(), false, "TAG 9 - PKM/PKB/Obsidian Parent Paths");
const tag10 = await tp.system.suggester(groupH_Display, groupH_Tags.sort(), false, "TAG 10 - Sub-Domain: Technical & Plugin Details");
const tag11 = await tp.system.suggester(groupJ_Display, groupJ_Tags.sort(), false, "TAG 11 - Cross-Cutting Concepts & Research");
```
### Prompt-engineering
```
...
const tag8 = await tp.system.suggester(groupI_Display, groupI_Tags.sort(), false, "TAG 8 - Sub-Doma
...
<%*
/* ═══════════════════════════════════════════════════════════════════════
   _report-&-permanent-note-template-master-v2.0.0
