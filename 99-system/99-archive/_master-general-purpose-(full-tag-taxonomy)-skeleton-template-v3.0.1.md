...
>
>This is a complete `YAML Frontmatter section Templater Template`. It incorporates the `PKB's current full Tag Taxonomy`. Found Here: [[reference-taxonomy-pur3v4d3r-tags_202511190109]]
>
```
<%*
/* ═══════════════════════════════════════════════════════════════════════
   MASTER GENERAL-NOTE TEMPLATE v3.0.1 (REORGANIZED)
