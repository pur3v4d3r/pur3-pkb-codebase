<%*
/* ═══════════════════════════════════════════════════════════════════════
   _permanent-note-pkb-&-pkm-template-v1.0.0
...
**{{CONTENT FROM MARKDOWN ASSISTANT GOES HERE}}**
...
try {
  // Configuration
  const folderPath = "04-library/02-pkb-and-pkm-learning"; // Change this to your folder
