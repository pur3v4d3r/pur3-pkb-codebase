...
```mermaid
graph TD
    subgraph "Tier 3: Integrative Architecture"
        R13["R13: The Predictive Mind<br/>⚡ Precision Flexibility"]
        R14["R14: The Meaningful Life<br/>📖 Narrative Metacognition"]
        R15["R15: The Examined Life Revisited<br/>👤 Integrated Cognitive Personhood"]
    end

    subgraph "Tier 2: Practical Extensions"
        R09["R09: The Embodied Thinker<br/>🫀 Physiological Metacognition"]
        R10["R10: The Feeling Reasoner<br/>🎨 Emotional Granularity as Epistemic Precision"]
        R11["R11: The Practical Reasoner<br/>⚖️ Action-Perception Link"]
        R12["R12: The Social Thinker<br/>🤝 Social Epistemic Virtue"]
    end

    subgraph "Tier 1: Epistemic Foundations"
        R01["R01: The Inquiry Engine<br/>❓ Aporic Receptivity"]
        R02["R02: The Fallible Knower<br/>🔍 Fallibilist Posture"]
        R03["R03: The Motivated Mind<br/>🔥 Cognitive Vitality"]
        R04["R04: Cognitive Scaffolding<br/>🏗️ Constructive Attentiveness"]
        R05["R05: The Virtuous Reasoner<br/>🛡️ Bias-Virtue Correspondence"]
        R06["R06: Taming System 1<br/>👁️ Governed Attentional Gap"]
        R07["R07: The Self-Directed Learner<br/>🔄 Recursive Self-Authorship"]
        R08["R08: Examined Life in Practice<br/>🎯 Epistemic Character"]
    end
    ...
    R08 -.->|"Tier 1 Capstone"| R09
    R12 -.->|"Tier 2 feeds into"| R13
    R13 -.->|"PP mechanism unifies all"| R15
    R14 -.->|"Narrative meaning frame"| R15

    style R08 fill:#FFC700,stroke:#333,color:#000
    style R15 fill:#FFC700,stroke:#333,color:#000
    style R13 fill:#9E6CD3,stroke:#333,color:#fff
```
...
```mermaid
graph LR
    subgraph "Build Specification Layer"
        MP["MASTER-PLAN"]
        PP["PKB Planning"]
        SP["PKB Architect Prompt"]
    end
    ...
    subgraph "Content Layer"
        REP["15 Reports"]
        REF["14 Reference Notes"]
        EXP["4 Expansion Topics"]
        GLO["Glossary"]
        DEV["Developmental Staging"]
        MET["Methodology"]
    end

    subgraph "Missing Layer"
        CON["0 Connection Notes"]
        GLOG["85 Missing Glossary Terms"]
        EXPG["11-21 Missing Expansion Topics"]
        REFG["16-36 Missing Reference Notes"]
    end
    ...
    style CON fill:#E50000,stroke:#333,color:#fff
    style GLOG fill:#E50000,stroke:#333,color:#fff
    style EXPG fill:#FF5700,stroke:#333,color:#fff
    style REFG fill:#FF5700,stroke:#333,color:#fff
```
...
```mermaid
graph TD
    subgraph "Ancient Philosophical Concepts"
        PRO["Prosoche<br/>(Stoic Attention)"]
        PROH["Prohairesis<br/>(Stoic Moral Purpose)"]
        PROP["Propatheiai<br/>(Pre-emotions)"]
        PAEU["Pathē/Eupatheia<br/>(Passions/Good-Feelings)"]
        PHRO["Phronimos<br/>(Practically Wise Person)"]
        APOR["Aporia<br/>(Productive Confusion)"]
        SOCI["Socratic Dialectic"]
        ASKE["Askesis<br/>(Spiritual Exercises)"]
        PROK["Prokoptōn<br/>(One Making Progress)"]
        SYNK["Synkatathesis<br/>(Assent)"]
    end

    subgraph "Modern Scientific Frameworks"
        META["Metacognitive Monitoring"]
        SDT["SDT Autonomy"]
        LED["LeDoux's Low Road"]
        TCE["Barrett's TCE Categories"]
        RPD["Klein's RPD Expert"]
        CONS["Constructivist Disequilibrium"]
        ARG["Mercier & Sperber<br/>Argumentative Theory"]
        PRAC["Deliberate Practice"]
        DREI["Dreyfus Skill Acquisition"]
        PREC["Precision Weighting"]
    end

    PRO ---|"≡ Functional identity"| META
    PROH ---|"≈ Structural isomorphism"| SDT
    PROP ---|"↔ Neural substrate"| LED
    PAEU ---|"↔ Reconceptualization"| TCE
    PHRO ---|"↔ Expertise model"| RPD
    APOR ---|"↔ Functional equivalence"| CONS
    SOCI ---|"↔ Functional account"| ARG
    ASKE ---|"↔ Therapeutic parallel"| PRAC
    PROK ---|"↔ Developmental parallel"| DREI
    SYNK ---|"↔ Computational mechanism"| PREC

    style PRO fill:#27FF00,stroke:#333,color:#000
    style META fill:#27FF00,stroke:#333,color:#000
    style SYNK fill:#9E6CD3,stroke:#333,color:#fff
    style PREC fill:#9E6CD3,stroke:#333,color:#fff
```
...
```mermaid
graph TD
    EP["Epistemology<br/>(R01-02)"]
    MOT["Motivation<br/>(R03)"]
    EDU["Educational Psychology<br/>(R04, R07)"]
    VIR["Virtue Epistemology<br/>(R05)"]
    COG["Cognitive Science<br/>(R06)"]
    EMB["Embodied Cognition<br/>(R09)"]
    EMO["Emotion Science<br/>(R10)"]
    PRA["Practical Wisdom<br/>(R11)"]
    SOC["Social Epistemology<br/>(R12)"]
    PP["Predictive Processing<br/>(R13)"]
    NAR["Narrative Psychology<br/>(R14)"]
    STO["Stoic Philosophy<br/>(Cross-cutting)"]
    ...
    PP -->|"Unifies all"| EMB
    PP -->|"Unifies all"| EMO
    NAR -->|"Meaning frame"| EP

    style PP fill:#9E6CD3,stroke:#333,color:#fff
    style STO fill:#27FF00,stroke:#333,color:#000
    style NAR fill:#FFC700,stroke:#333,color:#000
```
...
```mermaid
graph LR
    A["Aporic Receptivity"] --> B["Fallibilist Posture"]
    B --> C["Cognitive Vitality"]
    C --> D["Constructive Attentiveness"]
    D --> E["Bias-Virtue Correspondence"]
    E --> F["Governed Attentional Gap"]
    F --> G["Recursive Self-Authorship"]
    G --> H["Epistemic Character"]
    H --> I["Physiological Metacognition"]
    I --> J["Emotional Granularity"]
    J --> K["Action-Perception Link"]
    K --> L["Social Epistemic Virtue"]
    L --> M["Precision Flexibility"]
    M --> N["Narrative Metacognition"]
    N --> O["Integrated Cognitive Personhood"]

    style A fill:#FFC700,stroke:#333,color:#000
    style H fill:#FFC700,stroke:#333,color:#000
    style M fill:#9E6CD3,stroke:#333,color:#fff
    style O fill:#FFC700,stroke:#333,color:#000
```
