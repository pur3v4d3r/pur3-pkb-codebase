...
work-title: "How Emotions Are Made: The Secret Life of the Brain"
domain: affective-neuroscience
accessibility-rating: popular-science
cited-in-reports:
...
> - **Domain**: Affective Neuroscience, Predictive Processing, Emotion Science
> - **Accessibility**: Popular-science — written for general audiences, challenges widespread assumptions about universal emotion categories
> - **Cited in Reports**: [[report-09-the-embodied-reasoner|Report 09]], [[report-10-the-feeling-reasoner|Report 10]], [[report-13-the-predictive-mind|Report 13]]

---

## What This Work Contributes

[[Lisa-Feldman-Barrett]]'s *How Emotions Are Made* presents the **[[Theory-of-Constructed-Emotion]]** (TCE), one of the most radical reconceptualizations of emotion in contemporary cognitive science. Barrett challenges what she calls the "Classical View of Emotion" — the widespread assumption that each emotion (anger, fear, sadness, etc.) is a distinct, universal brain state with dedicated neural circuitry, characteristic expressions, and innate triggering conditions.

Against this view, Barrett argues that **emotions are constructed by the brain in the moment** through two integrated mechanisms:
...
### Report 10 — The Feeling Reasoner (Central Framework)

**Report 10 is built around Barrett's framework.** The report argues that emotions serve three functions:
1. Motivational fuel (Report 03)
...
- **[[Conceptualization]]**: The process by which core affect is categorized using learned emotion concepts to construct specific emotional experiences
...
- Barrett, Lisa Feldman. *How Emotions Are Made: The Secret Life of the Brain* (2017) — Popular-science account written for general audiences; uses clinical cases and everyday examples

**Original Theoretical Statement**:
- Barrett, L. F. (2017). "The theory of constructed emotion: An active inference account of interoception and categorization." *Social Cognitive and Affective Neuroscience*, 12(1), 1-23. — Technical companion paper with full theoretical apparatus

**Foundational Research**:
- Barrett, L. F., Gross, J., Christensen, T. C., & Benvenuto, M. (2001). "Knowing what you're feeling and knowing what to do about it: Mapping the relation between emotion differentiation and emotion regulation." *Cognition and Emotion*, 15(6), 713-724. — Original emotional granularity research
- Barrett, L. F., & Wormwood, J. B. (2015). "When a gun is not a gun: The context-dependence of conceptual knowledge for perception." In *The Conceptual Mind* (pp. 89-114). MIT Press. — Affective realism empirical demonstration

**Critical Engagement and Development**:
- Scarantino, A. (2017). "How to Do Things with Emotional Expressions: The Theory of Affective Pragmatics." *Psychological Inquiry*, 28(2-3), 165-185. — Critique and alternative framework
- Seth, A. K., & Friston, K. J. (2016). "Active interoceptive inference and the emotional brain." *Philosophical Transactions of the Royal Society B*, 371(1708), 20160007. — Mechanistic integration with predictive processing

**Contemporary Integration**:
- Barrett, L. F., & Simmons, W. K. (2015). "Interoceptive predictions in the brain." *Nature Reviews Neuroscience*, 16(7), 419-429. — Integration with broader neuroscience
- Kuppens, P., & Tong, E. M. (Eds.). (2021). *Handbook of Emotional Granularity*. Guilford Press. — Comprehensive review of granularity research and applications
...
- Digital formats (Kindle, iBooks, Kobo)
- Public library systems (widespread availability)
...
- **Related Reference Notes**: 
  - [[ref-damasio-descartes-error|Damasio — Descartes' Error]] (somatic markers as embodied signals)
  - [[ref-clark-surfing-uncertainty|Clark — Surfing Uncertainty]] (predictive processing framework)
