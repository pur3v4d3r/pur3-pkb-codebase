...
The first and most fundamental implication is the [[quality-over-quantity heuristic]]: when assessing or designing motivational environments, the primary question is not "how motivated are people here?" but "in what regulatory style?" High controlled motivation is not a success — it is a different kind of problem than low motivation, but it is still a problem, particularly over the longer term. Environments optimized for compliance produce different human beings than environments optimized for integrated regulation.
...
The most well-developed set of practical applications of OIT concerns educational and training environments. [[Vansteenkiste, Lens, & Deci (2006)]] synthesize the evidence into several evidence-based design principles:
...
The health behavior evidence is particularly instructive because it includes long-term outcomes. [[Williams et al. (2009)]] in a comprehensive review found that autonomy-supportive healthcare practices predicted sustained behavior change (12+ months) while controlling practices predicted short-term compliance that did not persist. The theoretical explanation is that autonomous motivation is self-maintaining — the person acts because they have genuinely internalized the value, not because external monitoring continues.
