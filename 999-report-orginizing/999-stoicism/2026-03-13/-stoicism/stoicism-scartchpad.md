...
aliases:
  ...
  - Stioic
  - Stoic Scratchpad
link-up: "[[pur3v4d3r-scratchpad-and-active-reading-notes_moc]]"
link-related: ""
---
### To-Do

- `Reference Notes -> to Create`
	- Stoic Techniques
	- Stoic Teachings
	- Stoic Quotes
	- Stoic generic precepts
		- Example: "Sovereign" general precept of Stoicism: "Some things are under our control and others are not".

- `Create` a Daily Note Addition that contains Daily Stoic Quotes that resonate with you that you can read at least once per day while working.
	- `Idea`: I could have the LLM embrace any of the Stoics and act as they are speaking to me daily.
		- I can have the LLM say teachings from Stoicism in the way that say Epictetus spoke, based on the surviving Stoic works.
	- `Idea`: I can design and build a Claude Project that is a Stoic Sage Teacher and guides me through Stoicism, as one of the founding Stoics.
- `Use` this as a starting point to have the LLM embrace a Stoic Teacher and Walk me through my daily meditation on Stoicism.
...
> Stoicism emphasizes internalizing philosophical principles until virtuous action flows naturally from character rather than requiring constant willpower exertion.

> The self-monitoring function of journaling appears particularly powerful for making gradual changes visible that would otherwise go unnoticed, providing reinforcement that sustains motivation through early stages when external rewards remain minimal.

> Professional Development and Performance Optimization
> 
> Marine and NATO commander General James Mattis carried *Meditations* on deployments in the Persian Gulf, Afghanistan, and Iraq, exemplifying how systematic philosophical reflection supports decision-making under pressure.

> Lack of Perceived Progress
> 
> Journaling benefits accrue gradually and are easily overlooked without systematic review. The solution involves periodic **meta-reflection**—reading previous journal entries at weekly or monthly intervals to observe patterns, progress, and recurring themes.

> Self Determination Theory and Stoicism
> 
> The distinction SDT draws between **controlled** and **autonomous** forms of regulation illuminates why Stoic journaling proves more sustainable than purely willpower-based approaches.
> - Even though behavior is self-controlled, it is perceived to originate from a source outside the person's "true" self when derived from relatively rigid internalized rules such as "I have to eat healthily" rather than from a sense of free choice.
> - Stoic practice, by emphasizing rational understanding of why virtue constitutes the sole genuine good, aims to transform external philosophical principles into deeply internalized values that feel self-authored rather than imposed—the highest form of autonomous motivation in SDT's taxonomy.


### To-Do
- Take the *Metacognitive Awareness Inventory* and have Claude or Gemini use that to construct **Stoic questions for daily reflection journaling**.
	- The questions have to be designed by:
		- A persona that know what their doing.
		- With real forethought to having me reflect Stoic about the days' event.
...
- Learning Journal, What is this?
	- You can't just summarize what you did, you must actively reflect on the day learning.
...
### Ideas
**Self Questioning Routines for**:
- Critical Thinking
- Metacognition
- Stoicism

Mentally rehearse generic precepts
...
- [[Wisdom]] **->** [Sophia/Phronesis] *->* [Practical wisdom, sound judgment]
	- [Did I see things clearly? -> Did I distinguish appearance from reality? -> Was my assessment accurate?]      
- [[Justice]] **->** [Dikaiosyne] *->* [Fairness, social virtue, treating others properly]
	- [Did I fulfill my duties? -> Did I treat others fairly? -> Did I act rightly toward others?]
- [[Courage]] **->** [Andreia] *->* [Endurance, facing difficulty, moral fortitude]
	- [Did I avoid cowardice? -> Did I endure difficulty? -> Where did I need more strength?]
- [[Moderation]] **->** [Sophrosyne] *->* [Self-control, discipline, appropriate restraint]
	- [Did I resist unhealthy impulses? -> Did I practice discipline? -> Where did I lack self-mastery?]  
...
- [[Practical Philosophy]] -> Needs MOC built. `[[practical-philosophy-moc]]`
- [[Ancient Philosophy]]
...
- [[Prohairesis]] -> [Moral Choice or Volition]
- [[Judgments]] ->
- [[Assent]] ->
- [[Impressions]] -> [phantasiai]

- [[Spiritual Exercises]] -> [askēsis]
	- [[Prosoche]]
	- [[View from Above]] -> [Kosmou Theōria]
...
3. Rely on habitual execution that requires minimal cognitive resources while periodically returning to journaling-based monitoring to ensure alignment with goals.[[2025-11-30]]
...
> 
> Rather than simply recording what was studied, the reflection examines **how** studying occurred, which strategies proved effective or ineffective, what conceptual confusions persist, and what approach adjustments might improve future learning.

> Emotional Regulation and Psychological Resilience
> 
> The practice involves documenting emotional reactions, identifying the interpretations generating those emotions, and systematically generating alternative interpretations grounded in Stoic principles.
...
- Research trials comparing self-monitoring through journaling versus direct intervention implementation found that both groups improved targeted behaviors after two weeks, but the self-monitoring group demonstrated higher study completion rates, suggesting that the metacognitive engagement fostered by journaling enhances commitment and persistence beyond what direct behavior change instructions alone produce.
- Journaling allows for self-reflection functioning as mild self-therapy, with tracking daily habits making small changes more noticeable and providing powerful positive reinforcement.
	- This reinforcement operates through what behavioral psychology terms the "[[Progress Principle|progress principle]]"—small, documented advances create positive affect and motivation that propel continued effort.
- For translating new knowledge to new behaviors, the brain must make new connections, but these new behaviors won't become lasting habits unless new connections built in brains are continuously strengthened over time.
...
- Value emerges exclusively through our [[Judgments]] and [[Assent]] to [[Impressions]] (*phantasiai*).
	- Our task is not to control events but to manage our [[Cognitive Responses]] to them.
...
### Marcus Aurelius
Marcus Aurelius used gratitude to shape is cognitive outlook, which serves multiple functions:
- Identifies specific virtues to emulate
- Social accountability, through recognition
- Counters Hedonic Adaptation -> [returning to base level]
Morning Preparation
- Told himself "The people I deal with today will be meddling, ungrateful, arrogant, dishonest, jealous, and surly."
	- This was to emotionally prepare for the challenges being faced throughout the day.
		- Reduces shock to unexpected events and preserves composure
...
### Epictetus
- Review events chronologically three times, in the order they occurred
...
[[Memory Enhancement]] through systematic review. Students were instructed to review events in chronological order—the people met, conversations had, tasks performed—essentially creating a mental replay of the day.
...
- The journal becomes the laboratory for this discipline:
> [!helpful-tip]
