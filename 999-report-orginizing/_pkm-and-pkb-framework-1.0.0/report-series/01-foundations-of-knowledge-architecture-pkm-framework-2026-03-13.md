...
>
> - **[[Cognitive Load Theory]]** — Introduced by implication in this report (the assimilation-accommodation balance and the chunking mechanism both touch on cognitive load), this framework becomes central in [[02-architecture-of-learning-pkm-framework-2026-03-13]], which addresses how cognitive load constraints should shape individual note design and PKB interaction patterns.
>
> - **[[Expert Knowledge Organization]]** — Chi et al.'s research on principle-based vs. surface-feature organization establishes a benchmark and a direction for PKB design: toward expert knowledge architecture from the beginning, not just as an eventual destination. This theme recurs in [[09-designing-the-learning-pkb-pkm-framework-2026-03-14]] and [[10-scaffolding-and-fading-pkm-framework-2026-03-14]], which address how PKB structure should evolve with developing expertise.
>
...
>
> - **[[Zone of Proximal Development]]** — Vygotsky's concept, briefly invoked in Phase IV's discussion of the assimilation-accommodation balance, is developed more fully in [[10-scaffolding-and-fading-pkm-framework-2026-03-14]] as the theoretical basis for adaptive PKB scaffolding.
>
