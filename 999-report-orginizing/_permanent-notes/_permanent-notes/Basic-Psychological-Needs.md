...
*Source: Educational Psychology / Psychology of Learning*

## Core Explanation

> [!evidence] Supporting Evidence
> **SDT Evidence in Self-Directed Learning Contexts**: Studies examining autonomous motivation in adult self-directed learning settings are particularly relevant for PKM. Vallerand et al.'s (1992) work on academic motivation demonstrated that perceived autonomy support from significant figures in the learning environment predicted autonomous self-regulation, which predicted higher-quality learning, persistence, and well-being. Studies on deliberate practice (Ericsson, Krampe, & Tesch-Römer, 1993)…

> [!evidence] Supporting Evidence
> **What the AGT Evidence Suggests for Self-Directed Adult Learning**: The AGT evidence base is drawn predominantly from formal educational settings — classrooms, academic programs, competitive sport — contexts with inherent normative comparison structures (grades, rankings, performance evaluations). PKB practice is structurally unusual by comparison: there is no external evaluator, no comparative ranking, and no normative standard against which performance is measured. In this structurally…

> [!evidence] Supporting Evidence
> **What the Stoic Evidence Suggests About Contemporary Motivational Frameworks**: The most striking implication of taking Stoic philosophy seriously alongside modern motivational psychology is that contemporary frameworks are almost uniformly *prosperous-conditions theories* — they describe motivation under favorable circumstances but have underdeveloped accounts of what happens when conditions are adverse. SDT describes what needs must be satisfied for intrinsic motivation to persist, but says…

> [!analytical-insight] Key Insight
> **The Motivational Problem in PKB is Structural, Not Dispositional**: The most common framing of PKB abandonment treats it as a willpower or discipline failure — the person lacked sufficient motivation or self-control to maintain their system. This framing is both empirically questionable and practically counterproductive. SDT research consistently demonstrates that motivation is primarily a *function of environmental conditions* rather than a fixed personal trait: when the environment…
...
> [!evidence] Supporting Evidence *(from goal-contents-theory-focused-analysis-2026-03-13.md)*
...
> [!example] **Application** *(from goal-contents-theory-focused-analysis-2026-03-13.md)*
...
> [!warning] **Key Distinction** *(from goal-contents-theory-focused-analysis-2026-03-13.md)*
