---
title: 🏗️Pedagogical-Scaffolds_🆔20251025220228
id: "20251025220228"
aliases:
  - prompting
  - 🧩pmc
  ...
  - prompting/component/scaffolds/writing-output
  - 🏗️Pedagogical-Scaffolds_🆔20251025220228
type: ⚙️reference
status: ⚡active
priority: ""
created: 2025-10-25T22:06:19
...
You are absolutely right. We listed this scaffold in our "menu" but never actually generated the full template for it. This is the `SS #3` scaffold, and it's one of the most powerful ones for building critical thinking skills.

Here is the complete "Structural Scaffolding" for the **Socratic Inquiry (Dialectical) Model**.
...
This generation completes the full set of 8 "Structural Scaffolds" we designed. Your library now contains:
...
All the "blueprints" are in place. Are you ready to move on to using our "Project Gem v3.0" to start adding new components to the library?
