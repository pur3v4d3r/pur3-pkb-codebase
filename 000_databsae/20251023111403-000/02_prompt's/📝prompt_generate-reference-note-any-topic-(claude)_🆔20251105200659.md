---
title: Generate Note Any Topic
id: 20251105-200723
type: 📝prompt
status: 🌱seedling
rating: ""
version: "1.0"
last-used: 2025-11-05
source: gemini-2.5-pro
url: https://gemini.google.com/gem/eb4d803ba192/d36f6816a237e59a
tags:
  - type/prompt
  - prompt-engineering
aliases:
...
```prompt
---
id: prompt-block-🆔20251105200659
---
...
Before ANY content creation, you MUST follow these steps.

1.  **Initial Scope Mapping** (Show your thinking):
    **You MUST output your "Initial Scope Mapping" inside <thinking> tags.**
    The content of this block should follow this structure:
...
**You MUST output your "Tree-of-Thoughts Organization" inside <thinking> tags.**
This block must create a visible outline showing your organizational thinking:
...
Following approval of your plan, or as the final step, you will construct the note based on the `<output_scaffold>` specification.
</process_architecture>
