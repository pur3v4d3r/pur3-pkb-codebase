...
This is the feedback loop that makes the foundry *learn*.
  ...
  - **THE CRITICAL STEP (Refinement):** You now *follow the wiki-links* back to the models you used.
    ...
    1. You go to the `🔗 Connections` section.
    ...
    1. You go to the `⚠️ Failure Modes & Limits` section and *add a new insight*: "Refinement: My inversion 'guarantee failure' was too focused on emotion. I didn't invert on the *financial* side, and I was almost caught without a buffer. A better inversion would be..."
...
[^2]:
    ...
    Ahrens, S. (2017). *How to Take Smart Notes: One Simple Technique to Boost Writing, Learning and Thinking – for Students, Academics and Nonfiction Book Writers*. Sönke Ahrens. (Provides a detailed analysis of Luhmann's Zettelkasten method).
